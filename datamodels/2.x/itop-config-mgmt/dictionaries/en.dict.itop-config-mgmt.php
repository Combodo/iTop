...
Dict::Add('EN US', 'English', 'English', [
	...
	'Class:NetworkDevice/Attribute:ios_end_of_support+' => 'When the IOS version is no more supported by the vendor, if this information is documented on the IOS Version.',
...
Dict::Add('EN US', 'English', 'English', [
	...
	'Class:Server/Attribute:os_end_of_support+' => 'When the OS version is no more supported by the vendor, if this information is documented on the OS Version.',
...
Dict::Add('EN US', 'English', 'English', [
	...
	'Class:SoftwareInstance/Attribute:software_end_of_support+' => 'When the software version is no more supported by the vendor, if this information is documented on the Software.',
