...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Create:Button+' => 'Créer un %4$s',
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Create:Modal:Title' => 'Ajouter un %4$s à %2$s',
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Remove:Button+' => 'Retirer ce %4$s',
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Remove:Modal:Title' => 'Retirer ce %4$s de son %1$s',
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Delete:Button+' => 'Supprimer ce %4$s',
	'Class:DBServer/Attribute:dbschema_list/UI:Links:Delete:Modal:Title' => 'Supprimer un %4$s',
	...
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Create:Button+' => 'Créer un %4$s',
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Create:Modal:Title' => 'Ajouter un %4$s à %2$s',
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Remove:Button+' => 'Retirer ce %4$s',
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Remove:Modal:Title' => 'Retirer ce %4$s de son %1$s',
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Delete:Button+' => 'Supprimer ce %4$s',
	'Class:FunctionalCI/Attribute:softwares_list/UI:Links:Delete:Modal:Title' => 'Supprimer un %4$s',
	...
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Create:Button+' => 'Créer un %4$s',
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Create:Modal:Title' => 'Ajouter un %4$s à %2$s',
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Remove:Button+' => 'Retirer ce %4$s',
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Remove:Modal:Title' => 'Retirer ce %4$s de son %1$s',
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Delete:Button+' => 'Supprimer ce %4$s',
	'Class:Rack/Attribute:enclosure_list chassis/UI:Links:Delete:Modal:Title' => 'Supprimer un %4$s',
