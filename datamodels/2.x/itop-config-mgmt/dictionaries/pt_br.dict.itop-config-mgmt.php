...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:FunctionalCI/Attribute:business_criticity' => 'Criticidade do negócio',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:PhysicalDevice/Attribute:location_name' => 'Nome da localidade',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:DatacenterDevice/Attribute:san_list+' => 'Todos os switches SAN vinculados a esse dispositivo',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Server/Attribute:logicalvolumes_list+' => 'Todos os volumoes lógicos vinculados a esse servidor',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:BusinessProcess+' => '',
	'Class:BusinessProcess/Attribute:applicationsolutions_list' => 'Solução de aplicação',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	'Class:DBServer' => 'Servidor de banco de dados',
	'Class:DBServer+' => '',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	'Class:DatabaseSchema' => 'Esquema de Banco de Dados',
	'Class:DatabaseSchema+' => '',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:VirtualDevice/Attribute:logicalvolumes_list+' => 'Todos os volumes lógicos vinculados a esse dispositivo',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:VirtualHost/Attribute:virtualmachine_list+' => 'Todas as máquinas virtuais hospedadas nesse Host',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Tape/Attribute:tapelibrary_name' => 'Nome da Tape library',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Patch/Attribute:documents_list+' => 'Todos os documentos vinculados a essa atualização',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Licence/Attribute:usage_limit' => 'Limite utilizado',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Brand/UniquenessRule:name' => 'Esse fabricante já existe',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Model/Attribute:type/Value:PowerSource+' => 'Fonte de energia',
	'Class:Model/Attribute:type/Value:DiskArray' => 'Array do disco',
	'Class:Model/Attribute:type/Value:DiskArray+' => 'Array do disco',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	'Class:lnkSoftwareInstanceToSoftwarePatch' => 'Link Instância Software / Atualização de Software',
	'Class:lnkSoftwareInstanceToSoftwarePatch+' => '',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Group/Attribute:ci_list+' => 'Todos os itens de configuração vinculados a esse grupo',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Menu:Application+' => 'Todas as aplicações',
	'Menu:DBServer' => 'Servidores de Banco de Dados',
	'Menu:DBServer+' => 'Servidores de Banco de Dados',
	'Menu:BusinessProcess' => 'Processos de negócios',
	'Menu:BusinessProcess+' => 'Todos os processos de negócios',
	'Menu:ApplicationSolution' => 'Soluções de aplicação',
	'Menu:ApplicationSolution+' => 'Todas as soluções de aplicações',
	'Menu:ConfigManagementSoftware' => 'Gerenciamento de aplicações',
	'Menu:Licence' => 'Licenças',
	'Menu:Licence+' => 'Todas as licenças',
	'Menu:Patch' => 'Atualizações',
	'Menu:Patch+' => 'Todas as atualizações',
	...
	'Menu:ConfigManagementHardware' => 'Gerenciamento de infra-estrutura',
	...
	'Menu:Server+' => 'Todos os servidores',
	'Menu:Printer' => 'Impressoras',
	'Menu:Printer+' => 'Todas as impressoras',
	'Menu:MobilePhone' => 'Telefone celulares',
	'Menu:MobilePhone+' => 'Todos os telefone celulares',
	'Menu:PC' => 'Estação de trabalho',
	'Menu:PC+' => 'Todas as estação de trabalho',
	'Menu:NewCI' => 'Novo IC',
	'Menu:NewCI+' => 'Novo IC',
	...
	'Menu:ConfigManagement:EndUsers' => 'Dispositivos de usuário final',
