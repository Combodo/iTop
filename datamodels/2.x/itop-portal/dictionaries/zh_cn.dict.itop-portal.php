...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
    ...
    'Brick:Portal:ListAllRequests:Tab' => '处理中和已关闭共担',
    'Brick:Portal:ListAllRequests:Title' => '全部工单',
    'Brick:Portal:ListAllRequests:Title+' => '<p>查看所有工单无论其为何种状态.</p>',
    ...
    'Brick:Portal:SearchInAllRequests:Title' => '在所有工单中搜索',
    'Brick:Portal:SearchInAllRequests:Title+' => '<p>无论其为何种状态.</p>',
