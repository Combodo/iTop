...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Menu:iTopHub:Register:Description' => '<p>Obter acesso à sua plataforma da comunidade iTop Hub!</br>Encontre todos os conteúdos e informações necessárias, gerencie suas instâncias '.ITOP_APPLICATION_SHORT.' por meio de ferramentas personalizadas & instale mais extensões.</br><br/>Ao conectar-se ao iTop hub a partir desta página, você enviará informações da sua instância '.ITOP_APPLICATION_SHORT.' ao iTop Hub.</p>',
	...
	'Menu:iTopHub:BrowseExtensions' => 'Obtenha extensões do iTop Hub',
	...
	'iTopHub:Landing:Status' => 'Status de implantação',
	'iTopHub:Landing:Install' => 'Implantando extensões...',
	...
	'iTopHub:Uncompressing' => 'Descompactando extensões...',
	...
	'iTopHub:InstallationEffect:NoChange' => 'Versão: %1$s já instalada. Nenhuma alteração realizada.',
