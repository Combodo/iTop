...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Menu:iTopHub:Register:Description' => '<p>进入iTop Hub社区平台！</br>寻找想要的内容和信息，管理本机扩展或安装新的扩展。</br><br/>通过这个页面连接到iTop Hub，本机的信息也会被推送到iTop Hub上。</p>',
	...
	'iTopHub:BackupFreeDiskSpaceIn' => '%1$s空闲空间在%2$s。',
	...
	'iTopHub:ConfigurationSafelyReverted' => '安装时发生错误!<br/>'.ITOP_APPLICATION_SHORT.'配置将不会改变。',
