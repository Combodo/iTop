...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Attachment:Max_Go' => '（最大文件尺寸：%1$sGB）',
	'Attachment:Max_Mo' => '（最大文件尺寸：%1$sMB）',
	'Attachment:Max_Ko' => '（最大文件尺寸：%1$sKB）',
	'Attachments:NoAttachment' => '没有附件。',
	'Attachments:PreviewNotAvailable' => '此附件类型不支持预览。',
	'Attachments:Error:FileTooLarge' => '上传的文件过大。%1$s',
	'Attachments:Error:UploadedFileEmpty' => '收到的文件为空，无法添加。可能是因为您发送的是空文件，或者咨询'.ITOP_APPLICATION_SHORT.'系统管理员服务器磁盘是否已满。',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Attachment/Attribute:contact_id' => '联系id',
