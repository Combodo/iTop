...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:cmdbAbstractObject/Method:SetCurrentUser/Param:1+' => '当前对象中要设置的字段. 如果此字段为字符串则使用显示名称, 否则将使用标识符. 显示名称为关联到用户的个人的姓名, 如果没有关联个人则为登录名.',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson' => '设置为当前个体',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson+' => '设置字段为当前登录的个人 (此 "个人" 关联到当前登录的 "用户").',
