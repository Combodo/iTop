...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Ticket/Attribute:agent_name' => '处理人名称',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:WorkOrder/Attribute:team_id' => '处理团队',
	'Class:WorkOrder/Attribute:team_id+' => '',
	'Class:WorkOrder/Attribute:team_name' => '团队名称',
	'Class:WorkOrder/Attribute:team_name+' => '',
	'Class:WorkOrder/Attribute:agent_id' => '处理人',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:cmdbAbstractObject/Method:Set+'                          => '设置字段为固定值',
	'Class:cmdbAbstractObject/Method:Set/Param:1'                   => '目标字段',
	'Class:cmdbAbstractObject/Method:Set/Param:1+'                  => '当前对象中要设置的字段',
	...
	'Class:cmdbAbstractObject/Method:SetCurrentDate+'               => '设置字段为当前日期和时间',
	'Class:cmdbAbstractObject/Method:SetCurrentDate/Param:1'        => '目标字段',
	'Class:cmdbAbstractObject/Method:SetCurrentDate/Param:1+'       => '当前对象中要设置的字段',
	'Class:cmdbAbstractObject/Method:SetCurrentDateIfNull'          => '非空时设置为当前日期',
	'Class:cmdbAbstractObject/Method:SetCurrentDateIfNull+'         => '当字段非空时设置为当前日期和时间',
	...
	'Class:cmdbAbstractObject/Method:SetCurrentUser+'               => '设置字段为当前登录用户',
	'Class:cmdbAbstractObject/Method:SetCurrentUser/Param:1'        => '目标字段',
	'Class:cmdbAbstractObject/Method:SetCurrentUser/Param:1+'       => '当前对象中要设置的字段。如果为字符型则使用通用名，否则将使用标识符。通用名为用户所关联的人员的名称，若无关联人员则使用登录名。',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson'              => '设置为当前人员',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson+'             => '设置字段为当前登录的用户（当前登录用户所关联的人员）。',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson/Param:1'      => '目标字段',
	'Class:cmdbAbstractObject/Method:SetCurrentPerson/Param:1+'     => '当前对象中要设置的字段。如果为字符型则使用通用名，否则将使用标识符。',
	'Class:cmdbAbstractObject/Method:SetElapsedTime'                => '设置耗费时长',
	'Class:cmdbAbstractObject/Method:SetElapsedTime+'               => '设置字段值为由另一个字段指定的时间经过的时长（秒）',
	...
	'Class:cmdbAbstractObject/Method:SetElapsedTime/Param:2+'       => '可以得到参考日期的字段',
	'Class:cmdbAbstractObject/Method:SetElapsedTime/Param:3'        => '工作时间',
	'Class:cmdbAbstractObject/Method:SetElapsedTime/Param:3+'       => '留空将基于标准的工作时间场景，或者设置设置为“DefaultWorkingTimeComputer”以强制使用24x7场景',
	'Class:cmdbAbstractObject/Method:SetIfNull'                     => '非空时设置',
	'Class:cmdbAbstractObject/Method:SetIfNull+'                    => '仅当为空时修改字段值为固定值',
	'Class:cmdbAbstractObject/Method:SetIfNull/Param:1'             => '目标字段',
	'Class:cmdbAbstractObject/Method:SetIfNull/Param:1+'            => '当前对象中要设置的字段',
	'Class:cmdbAbstractObject/Method:SetIfNull/Param:2'              => '值',
	'Class:cmdbAbstractObject/Method:SetIfNull/Param:2+'             => '要设置的值',
	'Class:cmdbAbstractObject/Method:AddValue'                       => '添加',
	'Class:cmdbAbstractObject/Method:AddValue+'                      => '给字段添加固定值',
	'Class:cmdbAbstractObject/Method:AddValue/Param:1'               => '目标字段',
	'Class:cmdbAbstractObject/Method:AddValue/Param:1+'              => '当前对象中要修改的字段',
	'Class:cmdbAbstractObject/Method:AddValue/Param:2'               => '值',
	'Class:cmdbAbstractObject/Method:AddValue/Param:2+'              => '被加法的数字，可以为负',
	'Class:cmdbAbstractObject/Method:SetComputedDate'                => '设为计算的日期',
	'Class:cmdbAbstractObject/Method:SetComputedDate+'               => '设置字段值为由其他字段和附加逻辑计算的日期值',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:1'        => '目标字段',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:1+'       => '当前对象中要修改的字段',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:2'        => '修饰符',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:2+'       => '修改源日期的语义信息，例如“+3 days”',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:3'        => '源字段',
	'Class:cmdbAbstractObject/Method:SetComputedDate/Param:3+'       => '做为源的字段，应用于修饰符逻辑',
	'Class:cmdbAbstractObject/Method:SetComputedDateIfNull'          => '非空时设为计算的日期',
	'Class:cmdbAbstractObject/Method:SetComputedDateIfNull+'         => '设置非空字段值为由其他字段和附加逻辑计算的日期值',
	...
	'Class:cmdbAbstractObject/Method:SetComputedDateIfNull/Param:2+' => '修改源日期的语义信息，例如“+3 days”',
	'Class:cmdbAbstractObject/Method:SetComputedDateIfNull/Param:3'  => '源字段',
	'Class:cmdbAbstractObject/Method:SetComputedDateIfNull/Param:3+' => '做为源的字段，应用于修饰符逻辑',
	...
	'Class:cmdbAbstractObject/Method:ApplyStimulus'                  => '应用刺激',
	'Class:cmdbAbstractObject/Method:ApplyStimulus+'                 => '应用指定的刺激到当前对象',
	'Class:cmdbAbstractObject/Method:ApplyStimulus/Param:1'          => '刺激编码',
	'Class:cmdbAbstractObject/Method:ApplyStimulus/Param:1+'         => '用于当前类的合法刺激编码',
	'Class:ResponseTicketTTO/Interface:iMetricComputer'              => '响应时限',
	'Class:ResponseTicketTTO/Interface:iMetricComputer+'             => 'SLT的响应时限',
	'Class:ResponseTicketTTR/Interface:iMetricComputer'              => '解决时限',
	'Class:ResponseTicketTTR/Interface:iMetricComputer+'             => 'SLT的解决时限',
));
