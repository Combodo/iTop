...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:cmdbAbstractObject/Method:SetCurrentUser/Param:1+'       => '当前对象中要设置的字段。如果为字符型则使用显示名，否则将使用标识符。显示名为用户所关联的人员的名称，若无关联人员则使用登录名。',
	...
	'Class:cmdbAbstractObject/Method:SetElapsedTime/Param:1+'       => '当前对象中要修改的字段',
