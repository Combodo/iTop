...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'iTopUpdate:UI:PostMaxSize' => 'PHP配置值post_max_size：%1$s',
	'iTopUpdate:UI:UploadMaxFileSize' => 'PHP配置值upload_max_filesize：%1$s',
    ...
    'iTopUpdate:Error:BadFileFormat' => '上传的不是zip格式文件',
    'iTopUpdate:Error:BadFileContent' => '升级文件不是程序升级包',
    'iTopUpdate:Error:BadItopProduct' => '升级文件与当前系统不兼容',
	...
	'iTopUpdate:UI:RestoreArchive' => '可以从归档文件“%1$s”还原应用程序',
	'iTopUpdate:UI:RestoreBackup' => '可以从“%1$s”还原数据库',
