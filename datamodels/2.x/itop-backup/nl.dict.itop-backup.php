...
Dict::Add('NL NL', 'Dutch', 'Nederlands', array(
	...
	'bkp-backup-running' => 'Er wordt momenteel een backup gemaakt. Even geduld...',
	...
	'bkp-wrong-format-spec' => 'De huidige specificatie voor bestandsnamen is ongeldig (%1$s). Een standaardspecificatie wordt toegepast: %2$s',
	'bkp-name-sample' => 'Backupbestanden krijgen een naam gebaseerd op databasekenmerken, datum en tijd. Voorbeeld: %1$s',
	...
	'bkp-next-to-delete' => 'Zal verwijderd worden bij de volgende backup-job (volgens de instelling "retention_count")',
