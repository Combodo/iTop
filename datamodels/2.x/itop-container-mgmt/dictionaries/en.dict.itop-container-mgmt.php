...
Dict::Add('EN US', 'English', 'English', array(
    ...
    'Class:ContainerApplication+' => 'An application deployed on a container environment',
    ...
    'Class:Cloud' => 'Cloud',
    'Class:Cloud+' => 'A type of Virtual Host that is hosted on a cloud provider. It can host Virtual Machines and Container Hosts',
