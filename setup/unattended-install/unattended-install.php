...
{
    echo <<<EOF
Usage: php unattended-install.php --param-file=<path_to_response_file> [--installation-xml=<path_to_installation_xml>] [--use-itop-config]
...
Options:
    ...
    --installation-xml=<path_to_installation_xml>  Use an installation.xml file to compute the modules to install depending on the selected extensions listed in the param file
    --use-itop-config                       Use the iTop configuration file to get the database settings, otherwise use the database settings from the parameters file
...
$bUseItopConfig = in_array('--use-itop-config', $argv);
