...
class DisplayableGraph extends SimpleGraph
{
	 ...
	 *
	 */
	public function Display(WebPage $oP, $aResults, $sRelation, ApplicationContext $oAppContext, $aExcludedObjects, $sObjClass, $iObjKey, $sContextKey, $aContextParams = [], bool $bLazyLoading = false)
	{
