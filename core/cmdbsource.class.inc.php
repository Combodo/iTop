...
class CMDBSource
{
	...
	/**
	 * @var int number of level for nested transactions
	 * @since 2.7.0 N°679
	 */
	protected static $m_aTransactionLevel = 0;
	...
	{
		return (self::$m_aTransactionLevel > 0);
	}
