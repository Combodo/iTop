...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'UI:Layout:NavigationMenu:MenuFilter:Input:Tooltip' => 'Digite palavras-chave para filtrar menus',
	'UI:Layout:NavigationMenu:MenuFilter:Input:Hint' => 'As correspondências de todos os grupos de menus serão exibidas',
