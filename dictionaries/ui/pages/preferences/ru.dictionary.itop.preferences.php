...
Dict::Add('RU RU', 'Russian', 'Русский', [
	...
	'UI:Favorites:General:ShowSummaryCards' => 'Показывать карточки сводки',
	'UI:Favorites:General:ShowSummaryCards+' => 'При наведении на гиперссылку на объект показывать краткую сводку по объекту, если она доступна для этого класса',
	...
	'UI:Preferences:PersonalizeKeyboardShortcuts:Button:Reset' => 'Сбросить',
	'UI:Preferences:PersonalizeKeyboardShortcuts:Button:Reset:Tooltip' => 'Вернуть сочетание клавиш по умолчанию',
	...
	'UI:Preferences:General:Toasts' => 'Расположение всплывающих уведомлений',
	'UI:Preferences:General:Toasts:Bottom' => 'Внизу',
	'UI:Preferences:General:Toasts:Top' => 'Вверху',
