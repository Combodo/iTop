...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'UI:Preferences:ActivityPanel:EntryFormOpened'                     => '默认开启的录入表单',
	'UI:Preferences:ActivityPanel:EntryFormOpened+'                    => '显示对象时是否开启录入表单。如果不勾选，您可以点击撰写按钮打开',
	...
	'UI:Preferences:ChooseAPlaceholder+'                               => '选择一个占位图片，将在用户联系人没有设定图片时显示',
));
