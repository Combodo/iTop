...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Core:UnknownObjectLabel' => '找不到对象 (类别: %1$s, id: %2$d)',
	...
	'Core:AttributeLinkedSet+' => '任何相同类别或子类的对象',
	...
	'Core:AttributeMetaEnum' => '自动计算',
	'Core:AttributeMetaEnum+' => '',

	'Core:AttributeLinkedSetIndirect' => '对象数组 (N-N)',
	'Core:AttributeLinkedSetIndirect+' => '任何相同类别或子类的对象',
	...
	'Core:AttributeObsolescenceFlag/Value:yes+' => '该对象排除在影响分析外, 并且在搜索结果中隐藏',
	'Core:AttributeObsolescenceFlag/Value:no' => '否',
	'Core:AttributeObsolescenceFlag/Label' => '废弃',
	...
	'Core:AttributeFinalClass+' => '对象真实的类别 (由内核自动创建)',
...
运算符:<br/>
	...
	'Core:AttributeExternalKey+' => '外部(或域外)键',

	'Core:AttributeHierarchicalKey' => '层级键',
	'Core:AttributeHierarchicalKey+' => '到达父级的外部(或域外)的键',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:CMDBChangeOp/Attribute:objclass+' => '变更实施对象的类别',
	'Class:CMDBChangeOp/Attribute:objkey' => '对象id',
	'Class:CMDBChangeOp/Attribute:objkey+' => '变更实施对象的id',
	'Class:CMDBChangeOp/Attribute:finalclass' => 'CMDB 操作子类',
	'Class:CMDBChangeOp/Attribute:finalclass+' => '将要执行那种变更',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:CMDBChangeOpSetAttributeScalar/Attribute:oldvalue+' => '此属性的以前的值',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:CMDBChangeOpSetAttributeBlob+' => '数据变更跟踪',
	'Class:CMDBChangeOpSetAttributeBlob/Attribute:prevdata' => '原值',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:EventNotification' => '已发送的通知',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EventIssue+' => '跟踪事件 (warning, error, 等等.)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EventWebService+' => '跟踪 WebService 调用',
	...
	'Class:EventWebService/Attribute:log_info+' => 'Info 记录',
	'Class:EventWebService/Attribute:log_warning' => 'Warning 日志',
	'Class:EventWebService/Attribute:log_warning+' => 'Warning 记录',
	'Class:EventWebService/Attribute:log_error' => 'Error 日志',
	'Class:EventWebService/Attribute:log_error+' => 'Error 记录',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EventRestService/Attribute:provider+' => '实现该功能的 PHP 类',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EventNotificationNewsroom/Attribute:priority/Value:1' => '严重',
	'Class:EventNotificationNewsroom/Attribute:priority/Value:1+' => '严重',
	...
	'Class:EventNotificationNewsroom/Attribute:read/Value:yes+' => '是',
	'Class:EventNotificationNewsroom/Attribute:read_date' => '阅读日期',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Action/Attribute:status+'                => '状态决定操作的行为',
	'Class:Action/Attribute:status/Value:test'      => '正在测试',
	'Class:Action/Attribute:status/Value:test+'     => '',
	'Class:Action/Attribute:status/Value:enabled'   => '生产',
	...
	'Class:Action/Attribute:trigger_list+' => '此操作链接的触发器',
	...
	'Action:last_executions_tab' => '最后执行',
	'Action:last_executions_tab_panel_title' => '此操作的执行 (%1$s)',
...
- $current_contact->attribute$ 触发通知的用户的属性',
	...
	'Class:ActionEmail/Attribute:html_template'             => 'HTML 模板',
	...
	'ActionEmail:preview_more_info'                         => '若需更多不同邮件客户端支持的 CSS 特性信息, 请参阅 %1$s',
	'ActionEmail:content_placeholder_missing'               => '占位符 "%1$s" 在 HTML 模板中不存在. 字段 "%2$s" 的内容将不会包含在生成的邮件中.',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:ActionNewsroom' => '新闻室通知',
	'Class:ActionNewsroom+' => '',
	'Class:ActionNewsroom/Attribute:title' => '标题',
	'Class:ActionNewsroom/Attribute:title+' => '新闻标题.可以包含占位符,如$this->attribute_code$',
	'Class:ActionNewsroom/Attribute:message' => '消息',
	'Class:ActionNewsroom/Attribute:message+' => '新闻内容,使用Markdown格式而非HTML.可以包含占位符,如:
- $this->attribute_code$ 触发通知对象的任何属性,
- $this->attribute_external_key->attribute$ 递归语法用于任何远程属性,
- $current_contact->attribute$ 触发通知的个人属性',
	'Class:ActionNewsroom/Attribute:icon' => '图标',
	'Class:ActionNewsroom/Attribute:icon+' => '在新闻室中新闻旁边显示的图标.
- 如果填写,将使用自定义图标
- 否则使用触发对象的图标（如果有,例如个体的头像）,
- 否则使用触发对象类的图标,
- 否则,使用应用程序紧凑徽标',
	...
	'Class:ActionNewsroom/Attribute:test_recipient_id+' => '测试通知时使用的收件人,替代收件人列表',
	'Class:ActionNewsroom/Attribute:recipients' => '收件人',
	'Class:ActionNewsroom/Attribute:recipients+' => '返回联系人对象的 OQL 查询',
	'Class:ActionNewsroom/Attribute:url' => 'URL',
	'Class:ActionNewsroom/Attribute:url+' => '默认指向触发通知的对象.但您也可以指定自定义URL.',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Trigger/Attribute:subscription_policy+'  => '允许用户取消订阅触发器',
	'Class:Trigger/Attribute:subscription_policy/Value:allow_no_channel' => '允许完全取消订阅',
	'Class:Trigger/Attribute:subscription_policy/Value:force_at_least_one_channel' => '强制至少一个渠道（新闻或邮件）',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnObject'                         => '触发器 (取决于类别)',
	'Class:TriggerOnObject+'                        => '基于指定类别对象上的触发器',
	'Class:TriggerOnObject/Attribute:target_class'  => '目标类别',
	'Class:TriggerOnObject/Attribute:target_class+' => '此类别的对象将激活触发器',
	'Class:TriggerOnObject/Attribute:filter'        => '筛选器',
	'Class:TriggerOnObject/Attribute:filter+'       => '限定将激活触发器的对象 (目标类别)',
	'TriggerOnObject:WrongFilterQuery'              => '错误的筛选查询: %1$s',
	'TriggerOnObject:WrongFilterClass'              => '查询返回的对象必须是 "%1$s"',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnPortalUpdate' => '触发器 (来自门户的更新时)',
	'Class:TriggerOnPortalUpdate+' => '终端用户在门户上更新时触发',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnStateChange' => '触发器 (状态发生变化时)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnStateEnter' => '触发器 (进入指定状态时)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnObjectCreate' => '触发器 (对象被创建时)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:TriggerOnObjectDelete' => '触发器 (对象被删除时)',
	'Class:TriggerOnObjectDelete+' => '指定类别或子类的对象被删除时的触发器',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:TriggerOnObjectUpdate+' => '指定类别或子类的对象被更新时的触发器',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:TriggerOnObjectMention+' => '指定类别或子类的对象在属性日志中提及 (@xxx) 时的触发器',
	'Class:TriggerOnObjectMention/Attribute:mentioned_filter' => '提及筛选器',
	'Class:TriggerOnObjectMention/Attribute:mentioned_filter+' => '限制列表中可激活触发器的被提及对象. 若为空,则任何被提及的对象(任何类)都会被激活.',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:TriggerOnAttributeBlobDownload+' => '指定类别或子类的对象的文档被下载时的触发器',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:lnkTriggerAction+' => '链接 触发器和操作',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:SynchroDataSource/Attribute:notify_contact_id+'          => '发生报错时要通知的联系人',
...
"使用主键": 复制的字段主键应包含'.ITOP_APPLICATION_SHORT.'对象的唯一标识',
	'Class:SynchroDataSource/Attribute:full_load_periodicity'       => '满负荷运行时间',
...
"value" 必须是该字段的授权值.',
	...
	'Class:SynchroDataSource/Attribute:action_on_zero/Value:error'          => '报错',
	'Class:SynchroDataSource/Attribute:action_on_one/Value:error'           => '报错',
	...
	'Class:SynchroDataSource/Attribute:action_on_multiple/Value:error'      => '报错',
	'Class:SynchroDataSource/Attribute:action_on_multiple/Value:take_first' => '使用第一个 (随机?)',
	'Class:SynchroDataSource/Attribute:delete_policy'                       => '删除策略',
	'Class:SynchroDataSource/Attribute:delete_policy+'                      => '复制废弃后要进行的操作:
"忽略": 无操作, 对应的对象保持在 itop 不变.
...
"更新并删除": 应用 "更新规则". 当达到保留期限后执行 "删除"',
	...
	'SynchroDataSource:Reconciliation' 		        => '搜索 &amp; 调和',
	...
	'Core:Synchro:ReconciledErrorsLabel'            => '报错',
	...
	'Core:Synchro:SynchroRunningStartedOn_Date'     => '开始于 %1$s 的同步仍在运行中...',
	...
	'Core:Synchro:label_obj_disappeared_errors'     => '报错 (%1$s)',
	...
	'Core:Synchro:label_obj_updated_errors'         => '报错 (%1$s)',
	...
	'Core:Synchro:label_obj_new_errors'             => '报错 (%1$s)',
	...
	'Core:SynchroReplica:PrivateDetails'                    => '私密详情',
	...
	'Core:BulkExport:SpreadsheetFormat' => 'HTML 表单(*.html)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Core:TagSetFieldData:ErrorTagCodeSyntax' => '标签编码必须介于3到 %1$d 个字符, 且以字母开头.',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:AsyncTask/Attribute:finalclass' => '根本属性',
