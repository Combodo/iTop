...
Dict::Add('NL NL', 'Dutch', 'Nederlands', array(
	...
	'Class:ActionEmail+' => '',
	'Class:ActionEmail/Attribute:status+' => 'Status beslist wie op de hoogte zal gesteld worden: enkel de testontvanger, iedereen (Aan, CC en BCC) of niemand',
	'Class:ActionEmail/Attribute:status/Value:test+' => 'Enkel de testontvanger zal op de hoogte gesteld worden',
	'Class:ActionEmail/Attribute:status/Value:enabled+' => 'Alle Aan, CC and BCC emails zullen op de hoogte gesteld worden',
