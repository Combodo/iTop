...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:User/Attribute:allowed_org_list' => 'Engedélyezett szervezetek',
	...
	'Class:UserInternal+' => ''.ITOP_APPLICATION_SHORT.'-n belül meghatározott felhasználó',
));
...
//
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:UserDashboard' => 'Felhasználói vezérlőpult',
	'Class:UserDashboard+' => '~~',
...
<li>Teljeskörű CMDB (Konfiguráció kezelés adatbázis) az IT eszközök dokumentálására és verzió kezelésére.</li>
<li>Incidens kezelés modul az összes IT-hez kapcsolódó kérelem életciklusának követésére.</li>
<li>Változás kezelés modul az IT infrastruktúra változásainak nyomonkövetésére és tervezésére.</li>
...
<div>Megtartottuk az '.ITOP_APPLICATION.' alapvető funkcióit, amelyeket szeretett, és modernizáltuk őket, hogy megszerettessük önnel.
...
<div>Szabja testre az '.ITOP_APPLICATION.' beállításait a kényelmesebb használathoz.</div>',
	...
	'UI:Treeview:CollapseAll' => 'Összes elrejtése',
	...
	'UI:Error:InvalidDashboardFile' => 'Hiba: Érvénytelen vezérlőpult fájl',
	'UI:Error:InvalidDashboard' => 'Hiba: Érvénytelen vezérlőpult',
	...
	'UI:Loading' => 'Betöltés...',
	'UI:Menu:Actions' => 'Intézkedések',
	'UI:Menu:OtherActions' => 'Egyéb intézkedések',
	...
	'UI:SearchValue:CheckAll' => 'Összes bejelőlése',
	...
	'UI:CSVReport-Row-Issue' => 'Kiadás: %1$s',
	...
	'UI:CSVReport-Row-Issue-DateFormat' => 'hibás dátum formátum',
	...
	'UI:RunQuery:ResultSQLCount' => 'Létrejött SQL a számításhozáshoz',
	...
	'UI:UserManagement:TitleActions' => 'Intézkedésekk',
	...
	'Menu:AdminTools?' => 'Eszközök csak az adminisztrátori profilhoz rendelt felhasználók számára elérhetők.',// Duplicated into itop-welcome-itil (will be removed from here...)
	'Menu:SystemTools' => 'Rendszer',

	'UI:ChangeManagementMenu' => 'Változás kezelés',
	...
	'UI:ConfigurationManagementMenu' => 'Konfiguráció kezelés',
	...
	'UI:ConfigMgmtMenuOverview:Title' => 'Konfiguráció kezelés vezérlőpult',
	...
	'UI:RequestMgmtMenuOverview:Title' => 'Kérelem kezelés vezérlőpult',
	...
	'UI:IncidentMgmtMenuOverview:Title' => 'Incidens kezelés vezérlőpult',
	...
	'UI:ChangeMgmtMenuOverview:Title' => 'Változás kezelés vezérlőpult',
	...
	'UI:ServiceMgmtMenuOverview:Title' => 'Szolgáltatás kezelés vezérlőpult',
...
<p><i><b>Triggerek</b></i> meghatározzák, hogy mikor kerüljön végrehajtásra az értesítés. Az iTop magjának részei a különböző triggerek, de a bővítményekkel továbbiak is létrehozhatók:
<ol>
...
<p>
<i><b>Intézkedések</b></i> meghatározzák a kiváltó programok végrehajtásakor végrehajtandó műveleteket. Egyelőre csak kétféle művelet létezik:
<ol>
	<li>Se-mail üzenet küldése: Az ilyen műveletek meghatározzák az e-mail küldéséhez használandó sablont, valamint az üzenet egyéb paramétereit, mint például a címzettek, fontosság stb.<br />
...
<p>Intézkedés végrehjatásához azt egy triggerhez kell rendelni.
Intézkedés triggerhez rendelésekor kap egy sorszámot , amely meghatározza az intézkedések végrehatási sorrendjét.</p>',
	...
	'UI:NotificationsMenu:Actions' => 'Intézkedések',
	'UI:NotificationsMenu:Actions:ActionEmail' => 'Email intézkedések',
	'UI:NotificationsMenu:Actions:ActionWebhook' => 'Webhook intézkedések (kimenő integrációk)',
	'UI:NotificationsMenu:Actions:Action' => 'Más intézkedések',
	'UI:NotificationsMenu:AvailableActions' => 'Lehetséges intézkedések',

	'Menu:TagAdminMenu' => 'Címkék konfigurációja',
	'Menu:TagAdminMenu+' => 'Címke érték kezelés',
	'UI:TagAdminMenu:Title' => 'Címke konfiguráció',
	'UI:TagAdminMenu:NoTags' => 'Nincs címke mező konfigurálva',
	...
	'Menu:UserManagementMenu' => 'Felhasználó kezelés',// Duplicated into itop-welcome-itil (will be removed from here...)
	...
	'Portal:DescriptionOfTheRequest' => 'Adja meg a kérelem leírásást:',
	...
	'UI:Toggle:SwitchToStandardDashboard' => 'Átváltás a sztenderd vezérlőpultra',
	'UI:Toggle:SwitchToCustomDashboard' => 'Átváltás az egyéni vezérlőpultra',
	...
	'UI:Dashboard:Actions' => 'Vezérlőpult műveletek',
	...
	'UI:DashletCreation:Dashboard' => 'Vezérlőpult',
	'UI:DashletCreation:DashletType' => 'Vezérlőpult típus',
	'UI:DashletCreation:EditNow' => 'Vezérlőpult szerkesztése',

	'UI:DashboardEdit:Title' => 'Vezérlőpult szerkesztő',
	'UI:DashboardEdit:DashboardTitle' => 'Felirat',
	...
	'UI:DashboardEdit:Revert' => 'Visszavon',
	'UI:DashboardEdit:Apply' => 'Alkalmaz',

	'UI:DashboardEdit:Layout' => 'Elrendezés',
	'UI:DashboardEdit:Properties' => 'Vezérlőpult tulajdonságai',
	...
	'UI:DashletUnknown:RenderText:View' => 'Nem lehet renderelni ezt a műszert.',
	'UI:DashletUnknown:RenderText:Edit' => 'Nem lehet renderelni ezt a műszert ("%1$s" osztály). Ellenőriztesse a rendszergazdával, hogy elérhető-e.',
	...
	'UI:DashletHeaderStatic:Prop-Title' => 'Felirat',
	...
	'UI:DashletHeaderDynamic:Prop-Title' => 'Felirat',
	...
	'UI:DashletBadge:Description' => 'Objektum ikon új/kersés',
	...
	'Month-11-Short' => 'Nov',
	'Month-12-Short' => 'Dec',
	'Calendar-FirstDayOfWeek' => '0',// 0 = Vasárnap, 1 = Hétfő, stb...
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Expression:Unit:Long:DAY' => 'nap(ok)',
	'Expression:Unit:Long:HOUR' => 'órá(k)',
	'Expression:Unit:Long:MINUTE' => 'perc(ek)',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Menu:UserManagementMenu'     => 'Felhasználó kezelés',
	...
	'Menu:UserManagement'         => 'Felhasználó kezelés',
