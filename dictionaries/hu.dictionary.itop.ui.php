...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
    ...
    'Class:AuditCategory+' => '',
    'Class:AuditCategory/Attribute:name' => 'Kategórinév',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
    ...
    'Class:TagSetFieldData/Attribute:finalclass' => 'Címkosztály',
...
<div>Szabja testre az '.ITOP_APPLICATION.' beállításait a kényelmesebb használathoz.</div>',
    ...
    'UI:Title:CSVImportStep2' => '2. lépés az 5-ből: CSV adat beálllítások',
    ...
    'UI:Delect:Confirm_Count_ObjectsOf_Class' => 'Hagyja jóvá a %2$s ostály %1$d objektumának törlését!',
    ...
    'UI:UserManagement:GrantMatrix' => 'Jogosutlságmátrix',
...
A művelet eseményindítóhoz rendelésekor kap egy sorszámot , amely meghatározza a műveletek végrehajtási sorrendjét.</p>',
    ...
    'UI:NotificationsMenu:OnStateEnter' => 'Objketum állapot felvétele',
