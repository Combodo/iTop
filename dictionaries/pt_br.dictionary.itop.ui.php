...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:User/Attribute:last_name+' => 'Nome do usuário correspondente',
	...
	'Class:User/Attribute:profile_list+' => 'Direitos de acesso para esse usuário',
	...
	'Class:User/Error:AtLeastOneOrganizationIsNeeded' => 'Pelo menos uma organização deve ser atribuída com esse usuário.',
...
<div>Personalize as preferências de seu '.ITOP_APPLICATION.' para uma experiência personalizada.</div>',
	...
	'UI:Menu:Modify' => 'Edição em massa...',
	...
	'UI:ResetPwd-Error-NoEmailAtt' => 'a conta não está associada a uma pessoa que contenha um endereço de e-mail no '.ITOP_APPLICATION_SHORT.'. Por favor, contate o administrador.',
...
Quando associada a um gatilho, cada ação recebe um número de "ordem", especificando em qual ordem as ações devem ser executadas.</p>',
	...
	'UI:Menu:ModifyAll' => 'Modificação em massa...',
	...
	'UI:NavigateAwayConfirmationMessage' => 'Quaisquer modificações serão descartados.',
...
<tr><td>s</td><td>segundos (2 dígitos, ex. 00..59)</td></tr>
	...
	'UI:LoginAgain' => 'Fazer login novamente',
