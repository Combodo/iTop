...
<div>Personalize as preferências de seu '.ITOP_APPLICATION.' para uma experiência personalizada.</div>',
	...
	'UI:Class_Object_NotUpdated' => 'Nenhuma alteração detectado, %1$s (%2$s) <strong>não</strong> foi modificado',
	...
	'UI:Title:Object_Of_Class_Created' => '%1$s - Criado(a) %2$s',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Menu:ProfilesMenu+' => 'Todos os perfis de usuário',
	'Menu:ProfilesMenu:Title' => 'Perfis',
	'Menu:UserAccountsMenu' => 'Contas de Usuários',
	'Menu:UserAccountsMenu+' => 'Todas as contas de usuários',
