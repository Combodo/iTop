...
- $current_contact->attribute$ attribut de la Personne qui a déclenché la notification',
	...
	'Class:ActionEmail/Attribute:html_template+'           => 'Optionnel, modèle HTML encapsulant le contenu du champ \'Message\' ci-dessous, utile pour des mises en page sur mesure (dans le modèle, le contenu du champ \'Message\' remplacera le placeholder $content$)',
	'Class:ActionEmail/Attribute:bypass_notify'            => 'Ignorer la préférence \'Notification\'',
	'Class:ActionEmail/Attribute:bypass_notify+'           => 'Si définie à \'Non\', les contacts ayant leur préférence \'Notification\' à \'Non\' ne seront pas notifiée.',
	'Class:ActionEmail/Attribute:bypass_notify/Value:no'   => 'Non',
	'Class:ActionEmail/Attribute:bypass_notify/value:yes'  => 'Oui',
