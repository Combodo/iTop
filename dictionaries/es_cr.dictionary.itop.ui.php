...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	...
	'Class:User/Attribute:last_name+' => 'Nombre del contacto correspondiente',
	'Class:User/Attribute:first_name' => 'Nombre',
	'Class:User/Attribute:first_name+' => 'Nombre del contacto correspondiente',
...
<li>Administrar el bien más importante de su infraestructura de TI: La Documentación.</li>
  ...
  'UI:ChangePwdMenu' => 'Cambiar Contrase&ntilde;a',
	...
	'UI:Query:UrlForExcel' => 'URL para usarse desde web queries de MS-Excel',
...
'UI-ServiceManagementOverview-ProviderContractToRenew' => 'contratos de Proveedores a ser Renovados en 30 días',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>En iTop las notificaciones son completamente personalizables. Estan basadas en dos conjuntos de objetos: <i>Disparadores y Acciones</i>.</p>
...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
  ...
  'Portal:Attachments' => 'Anexos',
	...
	'UI:ModifiedObject' => 'Objectp Modificado',
	'UI:BulkModifyStatus' => 'Operaración',
	...
	'UI:Pagination:HeaderSelection' => 'Total: %1$s objetos (%2$s objetos seleccionados).',
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
  ...
  'Class:URP_Users/Attribute:userid' => 'Contacto (Persona)',
	...
	'Class:URP_Users/Attribute:last_name' => 'Apellidos',
	'Class:URP_Users/Attribute:last_name+' => 'Apellidos del Contacto',
	'Class:URP_Users/Attribute:first_name' => 'Nombre(s)',
	'Class:URP_Users/Attribute:first_name+' => 'Nombre(s)',
