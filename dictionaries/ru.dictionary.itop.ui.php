...
Dict::Add('RU RU', 'Russian', 'Русский', [
	...
	'Class:AuditCategory/Attribute:ok_error_tolerance' => 'Порог предупреждения',
	'Class:AuditCategory/Attribute:ok_error_tolerance+' => 'Процент невалидных объектов, ниже которого результат считается предупреждением (оранжевый)',
	'Class:AuditCategory/Attribute:warning_error_tolerance' => 'Порог ошибки',
	...
	'Class:AuditRule/Attribute:process' => 'Процесс исправления',
	'Class:AuditRule/Attribute:process+' => 'Как это исправить? Кто должен это делать? …',
...
Домен обычно соответствует тому, кто отвечает за проверку и исправление ошибок',
	...
	'Class:lnkAuditCategoryToAuditDomain/Attribute:category_name+' => 'Название категории аудита',
	...
	'Class:Query/Attribute:is_template' => 'Шаблон для полей OQL',
	'Class:Query/Attribute:is_template+' => 'Может использоваться как источник OQL получателей в уведомлениях',
	'Class:Query/Attribute:is_template/Value:yes' => 'Да',
	'Class:Query/Attribute:is_template/Value:no' => 'Нет',
	'Class:Query/Attribute:export_count' => 'Счётчик экспортов',
	'Class:Query/Attribute:export_count+' => 'Счётчик, отражающий количество выполнений этого запроса',
	'Class:Query/Attribute:export_last_date' => 'Последний экспорт',
	'Class:Query/Attribute:export_last_date+' => 'Дата и время последнего выполнения экспорта',
	'Class:Query/Attribute:export_last_user_id' => 'Пользователь',
	'Class:Query/Attribute:export_last_user_id+' => 'Пользователь, выполнивший последний экспорт',
 ...
 - Тег "Дашлет" предполагает, что OQL возвращает объекты только одного класса.',
	'Class:Query/Attribute:usages/Value:export' => 'Экспорт',
	'Class:Query/Attribute:usages/Value:reference' => 'Пример для ИИ',
	'Class:Query/Attribute:usages/Value:notif' => 'Уведомление',
	'Class:Query/Attribute:usages/Value:draft' => 'Черновик',
	'Class:Query/Attribute:usages/Value:dashlet' => 'Дашлет',
	'Class:Query/Attribute:owner_id' => 'Ответственный',
	'Class:Query/Attribute:owner_id+' => 'Команда или человек, ответственные за этот запрос',
	'Query:baseinfo' => 'Общая информация',
	'Query:exportInfo' => 'Информация об экспорте',
	...
	'Class:User/Error:PrivilegedUserMustHaveAccessToBackOffice' => 'Профиль "%1$s" нельзя назначить привилегированным пользователям (Администраторам, Суперпользователям и пользователям REST-сервисов)',
	'Class:User/Error:ProfileNotAllowed' => 'Профиль "%1$s" нельзя добавить: это лишит доступа к консоли администрирования',
	'Class:User/Error:StatusChangeIsNotAllowed' => 'Изменение статуса своей учётной записи не разрешено',
	'Class:User/Error:AllowedOrgsMustContainUserOrg' => 'Разрешённые организации должны включать организацию пользователя',
	'Class:User/Error:AdminProfileCannotBeRemovedBySelf' => 'Нельзя снять с себя профиль Администратора. Попросите другого администратора сделать это за вас',
	'Class:User/Error:CurrentProfilesHaveInsufficientRights' => 'Нельзя лишить себя прав на редактирование пользователей',
	'Class:User/Error:PortalPowerUserHasInsufficientRights' => 'Профиль "Активный пользователь портала" не даёт достаточных прав доступа (необходимо добавить ещё один профиль)',
	...
	'Class:User/Warning:NoOrganizationMeansFullAccess' => 'Для этого пользователя не заданы "Разрешённые организации" — это означает доступ ко всем организациям',
	...
	'UI:Button:SaveAnd' => 'Сохранить и %1$s',
	...
	'UI:Error:ReadNotAllowedOn_Class' => 'Вам не разрешено просматривать объекты класса %1$s',
	...
	'UI:History:BulkImportDetails' => 'Изменения в результате импорта CSV, выполненного %1$s (пользователем %2$s)',
	...
	'UI:ApplicationEnvironment' => 'Окружение приложения: %1$s',
	...
	'UI:CSVImport:Column' => 'Столбец %1$s',
	...
	'UI:CSVImport:ViewAllPossibleValues' => 'Показать все возможные значения',
	'UI:CSVImport:ViewAllAmbiguousValues' => 'Показать все неоднозначные значения',
	...
	'UI:CSVReport-Value-SetIssue' => 'Недопустимое значение атрибута',
	'UI:CSVReport-Value-ChangeIssue' => '\'%1$s\' — недопустимое значение',
	'UI:CSVReport-Value-NoMatch' => 'Нет соответствия для значения \'%1$s\'',
	'UI:CSVReport-Value-NoMatch-PossibleValues' => 'Возможные значения \'%1$s\': %2$s',
	'UI:CSVReport-Value-NoMatch-NoObject' => 'Не найдено объектов \'%1$s\'',
	'UI:CSVReport-Value-NoMatch-NoObject-ForCurrentUser' => 'При текущем профиле не найдено объектов \'%1$s\'',
	'UI:CSVReport-Value-NoMatch-SomeObjectNotVisibleForCurrentUser' => 'Некоторые объекты \'%1$s\' недоступны при текущем профиле',
	...
	'UI:CSVReport-Row-Updated' => 'обновлено столбцов: %1$d',
	'UI:CSVReport-Row-Disappeared' => 'исчез, изменено столбцов: %1$d',
	...
	'UI:CSVReport-Value-Issue-AllowedValues' => 'Допустимые значения \'%1$s\': %2$s',
	...
	'UI:CSVReport-Row-Issue-ExpectedDateFormat' => 'Ожидаемый формат: %1$s',
	...
	'UI:Audit:Interactive:All:Title' => 'Результаты аудита',
	'UI:Audit:Interactive:All:SubTitle' => 'Полный аудит: включает все правила, все категории, все домены',
	'UI:Audit:Interactive:All:BreadCrumb' => 'Полный аудит',
	'UI:Audit:Interactive:All:BreadCrumb+' => 'Результаты аудита по всем правилам',
	'UI:Audit:Interactive:Categories:Title' => 'Результаты аудита по категориям: %1$s',
	'UI:Audit:Interactive:Categories:SubTitle' => 'Результаты аудита по всем правилам, относящимся к одной из этих категорий: %1$s',
	'UI:Audit:Interactive:Categories:BreadCrumb' => 'Категории',
	'UI:Audit:Interactive:Categories:BreadCrumb+' => 'Категории аудита: %1$s',
	'UI:Audit:Interactive:Domain:Title' => 'Результаты аудита по домену: %1$s',
	'UI:Audit:Interactive:Domain:SubTitle' => 'Результаты аудита по всем правилам категорий, относящихся к домену: %1$s',
	...
	'UI:Audit:Interactive:Selection:BadgeAll' => 'Все категории',
	'UI:Audit:Interactive:Button:Back' => 'Назад к аудиту',
	'UI:Audit:Interactive:Button:Configuration' => 'Настройка аудита',
	'UI:Audit:ViewRules' => 'Проверить правила',
	'UI:Audit:HeaderAuditRule' => 'Правило аудита',
	'UI:Audit:HeaderNbObjects' => '# Объекты',
	'UI:Audit:HeaderNbErrors' => '# Ошибки',
	'UI:Audit:PercentageOk' => '% Ok',
	'UI:Audit:OqlError' => 'Ошибка OQL',
	'UI:Audit:Error:ValueNA' => 'н/д',
	'UI:Audit:ErrorIn_Rule' => 'Ошибка в правиле',
	'UI:Audit:ErrorIn_Rule_Reason' => 'OQL ошибка в правиле %1$s: %2$s.',
	'UI:Audit:ErrorIn_Category' => 'Ошибка в категории',
	'UI:Audit:ErrorIn_Category_Reason' => 'OQL ошибка в категории %1$s: %2$s.',
	'UI:Audit:AuditErrors' => 'Ошибки аудита',
	'UI:Audit:Dashboard:ObjectsAudited' => 'Проверено объектов',
	'UI:Audit:Dashboard:ObjectsInError' => 'Объектов с ошибками',
	'UI:Audit:Dashboard:ObjectsValidated' => 'Валидных объектов',
	'UI:Audit:AuditCategory:Subtitle' => 'Ошибок: %1$s из %2$s — валидно %3$s%% объектов',
	...
	'UI:Schema:TitleForClass' => 'Схема %1$s',
	'UI:Schema:NoClassSelected' => 'Класс не выбран, пожалуйста, выберите',
	...
	'UI:Schema:ClassFilter' => 'Класс:',
	'UI:Schema:DisplayLabel' => 'Отображение:',
	'UI:Schema:DisplaySelector/LabelAndCode' => 'Название и код',
	'UI:Schema:DisplaySelector/Label' => 'Название',
	'UI:Schema:DisplaySelector/Code' => 'Код',
	'UI:Schema:Attribute/Filter' => 'Фильтр',
	'UI:Schema:DefaultNullValue' => 'Значение по умолчанию (null): "%1$s"',
	'UI:Schema:Events' => 'События',
	'UI:Schema:Events:Defined' => 'Определённые события',
	'UI:Schema:Events:NoEvent' => 'События не определены',
	'UI:Schema:Events:Listeners' => 'Обработчики событий',
	'UI:Schema:Events:NoListener' => 'Нет обработчиков событий',
	'UI:Schema:Events:Event' => 'Событие',
	'UI:Schema:Events:Description' => 'Описание',
	'UI:Schema:Events:Listener' => 'Обработчик',
	'UI:Schema:Events:Rank' => 'Ранг',
	'UI:Schema:Events:Module' => 'Модуль',
	'UI:LinksWidget:Autocomplete+' => 'Введите первые 3 символа...',
	'UI:Edit:SearchQuery' => 'Выбрать предопределённый запрос',
	...
	'UI:Delete:CannotDeleteBecause' => 'Не удалось удалить: %1$s',
	'UI:Delete:ShouldBeDeletedAtomaticallyButNotPossible' => 'Должен быть удалён автоматически, но это невозможно: %1$s',
	'UI:Delete:MustBeDeletedManuallyButNotPossible' => 'Должен быть удалён вручную, но это невозможно: %1$s',
...
<p>Для выполнения действия связываются с триггерами. При связывании с триггером каждому действию присваивается порядковый номер, который указывает на очерёдность выполнения действий при срабатывании триггера.</p>',
	...
	'UI:NotificationsMenu:Actions:ActionEmail' => 'Действия Email',
	'UI:NotificationsMenu:Actions:ActionWebhook' => 'Действия Webhook (исходящие интеграции)',
	'UI:NotificationsMenu:Actions:Action' => 'Другие действия',
	...
	'UI:Relation:NoneSelected' => 'Не выбрано',
	...
	'UI:RelationOption:Untitled' => 'Без названия',
	'UI:Relation:Key' => 'Ключ',
	'UI:Relation:Comments' => 'Комментарии',
	...
	'UI:Modify_ObjectsOf_Class' => 'Изменение объектов класса %1$s',
	...
	'UI:Menu:ModifyAll_Class' => 'Изменить объекты %1$s…',
	'UI:Menu:ModifyAll_Link' => 'Изменить %1$s…',
	'UI:Menu:ModifyAll_Remote' => 'Изменить %1$s…',
	...
	'UI:AttemptingToSetAReadOnlyAttribute_Name' => 'Попытка установить значение поля только для чтения: %1$s',
	'UI:FailedToApplyStimuli' => 'Операция не может быть выполнена.',
	'UI:StimulusModify_N_ObjectsOf_Class' => '%1$s: изменение %2$d объектов класса %3$s',
	'UI:CaseLogTypeYourTextHere' => 'Введите свой текст:',
	'UI:CaseLog:Header_Date_UserName' => '%1$s — %2$s:',
	'UI:CaseLog:InitialValue' => 'Исходное значение:',
	'UI:AttemptingToSetASlaveAttribute_Name' => 'Поле %1$s (%2$s) недоступно для записи, так как управляется синхронизацией данных. Значение не установлено.',
	'UI:ActionNotAllowed' => 'Вам не разрешено выполнять это действие над этими объектами.',
	'UI:BulkAction:NoObjectSelected' => 'Выберите хотя бы один объект для выполнения этой операции',
	'UI:AttemptingToChangeASlaveAttribute_Name' => 'Поле %1$s недоступно для записи, так как управляется синхронизацией данных. Значение осталось без изменений.',
	...
	'UI:ArchiveModeOn' => 'Включить режим архива',
	'UI:ArchiveModeOff' => 'Выключить режим архива',
	'UI:ArchiveMode:Banner' => 'Режим архива',
	'UI:ArchiveMode:Banner+' => 'Архивные объекты видны, изменения запрещены',
	...
	'UI:Create_Class_InState' => 'Создать %1$s в статусе: ',
	...
	'UI:ExtKey_AsLink' => '%1$s (ссылка)',
	'UI:ExtKey_AsFriendlyName' => '%1$s (полное название)',
	'UI:ExtField_AsRemoteField' => '%1$s (%2$s)',
	'UI:Button:MoveUp' => 'Вверх',
	'UI:Button:MoveDown' => 'Вниз',
	'UI:OQL:UnknownClassAndFix' => 'Неизвестный класс "%1$s". Возможно, вы имели в виду "%2$s".',
	...
	'UI:DashboardEdit:Revert' => 'Отменить',
	'UI:DashboardEdit:Apply' => 'Применить',
	...
	'UI:DashletUnknown:Label' => 'Неизвестно',
	'UI:DashletUnknown:Description' => 'Неизвестный дашлет (возможно, был удалён)',
	'UI:DashletUnknown:RenderText:View' => 'Не удалось отобразить этот дашлет.',
	'UI:DashletUnknown:RenderText:Edit' => 'Не удалось отобразить этот дашлет (класс "%1$s"). Уточните у администратора, доступен ли он.',
	'UI:DashletUnknown:RenderNoDataText:Edit' => 'Предпросмотр для этого дашлета недоступен (класс "%1$s").',
	'UI:DashletUnknown:Prop-XMLConfiguration' => 'Конфигурация (в виде необработанного XML)',
	'UI:DashletProxy:Label' => 'Прокси',
	'UI:DashletProxy:Description' => 'Прокси-дашлет',
	'UI:DashletProxy:RenderNoDataText:Edit' => 'Предпросмотр для этого стороннего дашлета недоступен (класс "%1$s").',
	'UI:DashletProxy:Prop-XMLConfiguration' => 'Конфигурация (в виде необработанного XML)',
	...
	'UI:Menu:FilterList' => 'Показать список с критериями поиска',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:About:RemoteExtensionSource' => 'Данные',
	...
	'UI:CurrentObjectIsSoftLockedBy_User' => 'Этот объект сейчас редактируется пользователем %1$s. Вы сможете отправить свои изменения после того, как он закончит.',
	...
	'UI:Newsroom:ResetCache:Success:Message' => 'Кэш ленты новостей успешно сброшен',
	...
	'UI:Newsroom:Priority:1:Tooltip' => 'Критический',
	...
	'Menu:AuditCategories+' => 'Категории аудита',
	'Menu:AuditCategories:Title' => 'Настройка аудита',
