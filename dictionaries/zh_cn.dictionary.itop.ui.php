...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_UserProfile/Name' => '链接%1$s与%2$s',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_UserOrg/Name' => '链接%1$s与%2$s',
...
<div>定制化您的'.ITOP_APPLICATION.'设置，实现个性化体验。</div>',
	...
	'UI:Error:2ParametersMissing' => '错误：必须为该操作指定以下参数：%1$s和%2$s。',
	'UI:Error:3ParametersMissing' => '错误：必须为该操作指定以下参数：%1$s，%2$s和%3$s。',
	'UI:Error:4ParametersMissing' => '错误：必须为该操作指定以下参数：%1$s，%2$s，%3$s和%4$s。',
	...
	'UI:RunQuery:DevelopedOQLCount' => '优化的OQL计数',
	...
	'UI:Schema:Links:n-n' => '类链接到%1$s（n:n链接）：',
	...
	'UI:ManageObjectsOf_Class_LinkedWith_Class_Instance' => '管理%1$s个对象，链接%2$s：%3$s',
	...
	'UI:Delete:Count_Objects/LinksReferencing_Object' => '一共%1$d个对象/链接关联了%2$s',
...
当与一个触发器关联时，每个操作都被赋予一个顺序号，规定了按什么样的顺序执行这些操作。</p>',
	...
	'Portal:NoOpenRequest' => '该类别中没有打开的请求。',
	'Portal:NoClosedRequest' => '该分类中没有请求',
...
<tr><td>s</td><td>秒（2位数, 比如 00..59）</td></tr>
	...
	'UI:CurrentObjectIsLockedBy_User_Explanation' => '该对象正在被%1$s修改。您的修改无法提交因为它们会冲突。',
