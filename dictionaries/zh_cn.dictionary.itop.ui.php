...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:QueryOQL/Attribute:fields+' => '属性之间使用逗号分隔 (或 alias.attribute) 来导出',
	'Class:QueryOQL' => 'OQL 查询',
	'Class:QueryOQL+' => '一种基于对象的查询语言',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:User/Attribute:org_id+' => '相关人员的组织',
	'Class:User/Attribute:last_name' => '姓',
	'Class:User/Attribute:last_name+' => '相关联系人的姓氏',
	'Class:User/Attribute:first_name' => '名',
	'Class:User/Attribute:first_name+' => '相关联系人的名字',
	'Class:User/Attribute:email' => '邮箱',
	'Class:User/Attribute:email+' => '相关联系人的邮箱',
...
<li>管理IT 中最重要的资产: 文档.</li>
	...
	'UI:Error:2ParametersMissing' => '错误: 必须为该操作指定以下参数: %1$s 和 %2$s.',
	'UI:Error:3ParametersMissing' => '错误: 必须为该操作指定以下参数: %1$s, %2$s 和 %3$s.',
	'UI:Error:4ParametersMissing' => '错误: 必须为该操作指定以下参数: %1$s, %2$s, %3$s 和 %4$s.',
	...
	'UI:Error:MaintenanceMode' => '应用正处于维护状态',
	...
	'UI:History:BulkImports+' => 'CSV 导入清单 (最新的导入在前)',
	...
	'UI:ResetPwd-EmailSent' => '请检查您的收件箱并按照指引进行操作. 如果您未收到邮件, 请检查您的输入是否正确.',
	...
	'UI:Login:Error:MultipleContactsHaveSameEmail' => '多个联系人使用相同的邮箱地址',
	'UI:Login:Error:NoValidProfiles' => '提供的资料无效',
	...
	'UI:CSVImport:SeparatorTab+' => 'TAB 键',
	...
	'UI:CSVImport:TreatFirstLineAsHeader' => '将第一行视做标题(列名)',
	...
	'UI:CSVImport:CommentsAndHeader' => '注释和标题',
	...
	'UI:Schema:DisplaySelector/LabelAndCode' => '标签和代码',
	'UI:Schema:DisplaySelector/Label' => '标签',
	...
	'UI:Error:ActionNotAllowed' => '您无权操作',
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>~~',
	...
	'UI:PrintResolution:LetterPortrait' => '纵向',
	'UI:PrintResolution:LetterLandscape' => '横向',
