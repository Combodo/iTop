...
域通常对应负责检查和修复错误的人员',
	...
	'Class:User/Error:PortalPowerUserHasInsufficientRights' => 'Portal power user角色没有足够的访问权限 (还需要添加别的角色)',
	...
	'Class:User/Warning:NoContactHasImpact' => '注意: 此用户没有定义任何人员, 将会影响例后台功能如无法访问门户, 接收消息提醒等',
	'Class:User/Warning:NoOrganizationMeansFullAccess' => '此用户没有定义 "允许访问的组织", 这将导致用户可以访问所有组织',
...
<tr><td>s</td><td>秒 (2位数, 比如 00..59)</td></tr>
	...
	'UI:Newsroom:Priority:4:Tooltip' => '一般',
	'UI:Newsroom:ResetCache' => '刷新缓存',
	'UI:Newsroom:ResetCache:Success:Message' => '您的消息空间缓存已成功刷新',
...
<ol>
	...
	<li>发送消息空间信息: 直接在应用中通过消息空间 (左侧菜单中的铃铛图标) 给用户显示一个信息</li>
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'UI:ObjectShortcutInsert' => '插入对象快捷方式',
