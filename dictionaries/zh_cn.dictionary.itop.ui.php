...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_UserProfile/Attribute:profile+' => '名称',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_ProfileProjection/Attribute:profile+' => '名称',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_StimulusGrant/Attribute:permission+' => '允不允许?',
...
<div>Customize your '.ITOP_APPLICATION.' preferences for a personalized experience.</div>',
	...
	'UI:Error:InvalidGroupByFields' => '分组字段列表无效: "%1$s".',
	...
	'UI:Error:Invalid_Stimulus_On_Object_In_State' => '%2$s 当前处于 "%3$s" 状态, "%1$s" 操作无法应用.',
	'UI:Error:InvalidDashboardFile' => 'Error: 无效的仪表盘文件',
	'UI:Error:InvalidDashboard' => 'Error: 无效的仪表盘',
	'UI:Error:MaintenanceMode' => '应用当前处于维护之中',
	'UI:Error:MaintenanceTitle' => '维护',
	'UI:Error:InvalidToken' => 'Error: 所请求的操作已执行 (未找到 CSRF token )',
	...
	'UI:LogOff:ClickHereToLoginAgain'              => '请点击这里重新登录...',
	...
	'UI:CSVImport:CommentsAndHeader' => '备注和标头',
	...
	'UI:CSVReport-Value-Issue-Readonly' => '\'%1$s\' 的属性是只读,无法修改 (当前值: %2$s, 建议值: %3$s)',
	...
	'UI:Schema:Default_Description' => '默认: "%1$s"',
	...
	'UI:Schema:Class_IsLinkedTo_Class_Via_ClassAndAttribute' => '%1$s 被关联到 %2$s 通过 %3$s::<em>%4$s</em>',
	...
	'UI:Schema:LifeCycleAttributeMustChange' => '必须改变',
	...
	'UI:RemoveLinkedObjectsOf_Class' => '删除',
	'UI:Message:EmptyList:UseAdd' => '列表为空, 请使用 "添加..." 按扭来添加.',
	...
	'UI:Class_Object_NotUpdated' => '未发生变化, %1$s (%2$s) <strong>没有</strong> 被更新.',
	'UI:Class_Object_Updated' => '%1$s (%2$s) 已更新.',
	'UI:BulkDeletePageTitle' => ITOP_APPLICATION_SHORT.' - 批量删除',
	'UI:BulkDeleteTitle' => '请选择您要删除的对象:',
...
<ol>
	<li>当特定对象 <b>新建</b>, <b>更新</b> 或 <b>删除</b> 时,某些操作会被触发.</li>
	<li>当特定对象 <b>进入</b> 或 <b>离开</b> 特定 <b>状态</b> 时,某些操作会被触发.</li>
	<li>当特定对象 <b>达到 TTO 或 TTR 阈值</b> 时,某些操作会被触发.</li>
</ol>
</p>
<p>
...
当与触发器关联时, 每个行为都有序号, 指定了按照什么样的顺序执行这些操作.</p>',
	...
	'UI:Pagination:HeaderSelection' => '共: %1$s 项(已选择 %2$s ).',
