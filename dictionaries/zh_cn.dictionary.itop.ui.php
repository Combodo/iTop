...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:AuditRule/Attribute:category_id+' => '此规则对应的类别',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Query/Attribute:description+' => '请描述此查询（用途、用法等等）',
	'Class:Query/Attribute:is_template' => 'OQL字段模板',
	'Class:Query/Attribute:is_template+' => '通知的收件人OQL中可用',
	...
	'Class:Query/Attribute:export_last_date' => '上次导出',
	'Class:Query/Attribute:export_last_user_id' => '用户',
	'Class:Query/Attribute:export_last_user_contact' => '联系人',
	'Query:baseinfo' => '常规信息',
	'Query:exportInfo' => '导出信息',
	'Class:QueryOQL/Attribute:fields' => '属性字段',
	'Class:QueryOQL/Attribute:fields+' => '导出时属性之间使用逗号分隔（或者alias.attribute）',
	'Class:QueryOQL' => 'OQL查询',
	'Class:QueryOQL+' => '基于OQL的查询',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:User/Error:ProfileNotAllowed' => '无法添加角色“%1$s”，这将禁用后台访问权限。',
	'Class:User/Error:StatusChangeIsNotAllowed' => '不允许修改您自己用户账号的状态。',
	'Class:User/Error:AllowedOrgsMustContainUserOrg' => '允许访问的组织必须包含用户组织',
	'Class:User/Error:CurrentProfilesHaveInsufficientRights' => '当前角色列表不包含足够的访问权限（用户账号将无法被修改）',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_UserProfile/Name' => '关联%1$s与%2$s',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_UserOrg/Name' => '关联%1$s与%2$s',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_ActionGrant/Attribute:permission+' => '是否允许？',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:URP_StimulusGrant/Attribute:permission+' => '是否允许？',
...
<div>此版本全新设计了一个现代的、易用的后台界面。</div>

<div>我们不仅保留'.ITOP_APPLICATION.'中您所喜爱的核心功能，同时使其更具现代化。
我们衷心希望您喜爱此版本，正如我们在设想和实现它的时候一样。</div>

<div>定制化您的'.ITOP_APPLICATION.'设置，实现个性化体验。</div>',
	'UI:WelcomeMenu:AllOpenRequests' => '所有打开的请求：%1$d',
	'UI:WelcomeMenu:MyCalls' => '我处理的请求',
	...
	'UI:LoggedAsMessage+Admin' => '以%1$s身份登录（%2$s，超级管理员）',
	'UI:Button:Logoff' => '注销',
	...
	'UI:Error:UploadedFileTooBig' => '所上传的文件太大（允许的最大限制是%1$s）。请检查PHP配置文件中的upload_max_filesize和post_max_size。',
	...
	'UI:Error:UploadStoppedByExtension_FileName' => '上传因为扩展名被停止（原始文件名称为“%1$s”）。',
	'UI:Error:UploadFailedUnknownCause_Code' => '文件上传失败，原因未知（错误代码为“%1$s”）。',
	...
	'UI:Error:AnErrorOccuredWhileRunningTheQuery_Message' => '运行此查询时出现错误：%1$s',
	'UI:Error:ObjectAlreadyUpdated' => '错误：此对象已更新。',
	'UI:Error:ObjectCannotBeUpdated' => '错误：对象无法更新。',
	'UI:Error:ObjectsAlreadyDeleted' => '错误：对象已被删除！',
	'UI:Error:BulkDeleteNotAllowedOn_Class' => '您无权进行%1$s类对象的批量删除',
	'UI:Error:DeleteNotAllowedOn_Class' => '您无权删除%1$s类的对象',
	'UI:Error:ReadNotAllowedOn_Class' => '您无权查看对象的%1$s',
	'UI:Error:BulkModifyNotAllowedOn_Class' => '您无权进行%1$s类对象的批量更新',
	'UI:Error:ObjectAlreadyCloned' => '错误：此对象已被克隆！',
	'UI:Error:ObjectAlreadyCreated' => '错误：此对象已被创建！',
	'UI:Error:Invalid_Stimulus_On_Object_In_State' => '错误：在对象%2$s的“%3$s”状态上的刺激“%1$s”是无效的。',
	...
	'UI:Error:InvalidToken' => '错误：所请求的操作已执行（未发现CSRF token）',
	...
	'UI:History:BulkImports+' => 'CSV导入列表（最新导入在最上面）',
	'UI:History:BulkImportDetails' => 'CVS导入所致的对于%1$s（被%2$s）的更改',
	'UI:History:Date' => '日期',
	...
	'UI:ResetPwd-Error-NoContact' => '此账户没有关联到人员。',
	...
	'UI:CSVImport:DataLine1'                       => '数据行1',
	'UI:CSVImport:DataLine2'                       => '数据行2',
	...
	'UI:Title:CSVImportStep2' => '步骤2共计5：CSV数据选项',
	'UI:Title:CSVImportStep3' => '步骤3共计5：数据映射',
	'UI:Title:CSVImportStep4' => '步骤4共计5：模拟导入',
	'UI:Title:CSVImportStep5' => '步骤5共计5：完成导入',
	...
	'UI:CSVImport:Skip_N_LinesAtTheBeginning' => '跳过文件开始的前%1$s行',
	...
	'UI:CSVImport:AdvancedMode+' => '在高级模式中,对象的“id”（主键）可以被用来修改和重命名对象。无论如何，“id”（如果存在）只能被用做一个搜索条件，不能与其它搜索条件混用。',
	...
	'UI:UniversalSearch:LabelSelectTheClass' => '选择要搜索的类：',
	...
	'UI:CSVReport-Value-Issue-NoMatch' => '属性“%1$s”的值无效：无法匹配，请检查拼写',
	'UI:CSVReport-Value-Issue-Unknown' => '属性“%1$s”的值无效： %2$s',
	...
	'UI:CSVReport-Row-Issue-Reconciliation' => '无法对账',
	'UI:CSVReport-Row-Issue-Ambiguous' => '不明确的对账',
	...
	'UI:CSVReport-Object-MissingUpdated' => '缺少对象：已更新',
	...
	'UI:CSVExport:AdvancedMode+' => '高级模式中，多个字段被添加至导出中：对象id，关联外部对象的id及其同步属性。',
	'UI:CSVExport:LostChars' => '编码问题',
	'UI:CSVExport:LostChars+' => '下载文件将使用%1$s编码。' . ITOP_APPLICATION_SHORT . '检测到不兼容的字符。这些字符或者被子集替代（例如重音字丢失重音），或者被丢弃。您可以从浏览器拷贝数据以供粘贴。或者您也可以联系系统管理员更改字符编码（见参数“csv_file_default_charset”）。',
	...
	'UI:Audit:PercentageOk' => '%正确',
	'UI:Audit:OqlError' => 'OQL错误',
	'UI:Audit:Error:ValueNA' => 'n/a',
	'UI:Audit:ErrorIn_Rule' => '规则中有错误',
	'UI:Audit:ErrorIn_Rule_Reason' => 'OQL错误位于规则%1$s：%2$s。',
	'UI:Audit:ErrorIn_Category' => '错误位于类别',
	'UI:Audit:ErrorIn_Category_Reason' => 'OQL错误位于类别%1$s：%2$s。',
	...
	'UI:RunQuery:DevelopedQuery' => '生成的查询表达式: ',
	'UI:RunQuery:SerializedFilter' => '序列化的过滤器: ',
	'UI:RunQuery:DevelopedOQL' => '生成的OQL',
	'UI:RunQuery:DevelopedOQLCount' => '生成的OQL计数',
	'UI:RunQuery:ResultSQLCount' => '结果SQL计数',
	'UI:RunQuery:ResultSQL' => '结果SQL',
	'UI:RunQuery:Error' => '运行此查询时出现错误',
	'UI:Query:UrlForExcel' => 'MS-Excel网络查询所使用的URL',
	'UI:Query:UrlV1' => '字段列表未指定。此页面<em>export-V2.php</em>没有此信息无法被调用。因此，下面所建议的URL指向传统页面：<em>export.php</em>。此传统版本的导出有如下的限制：导出的字段严重依赖于'.ITOP_APPLICATION_SHORT.'的导出格式喝数据模型。<br/>如果您需要保证导出列列表长久保持稳定，您必须为属性“Fields”指定值并使用页面<em>export-V2.php</em>。',
	'UI:Schema:Title' => ITOP_APPLICATION_SHORT.'对象模型',
	'UI:Schema:TitleForClass' => '%1$s场景',
	...
	'UI:Schema:RelationPropagates' => '%1$s：复制到%2$d个层级，查询：%3$s',
	'UI:Schema:RelationDoesNotPropagate' => '%1$s：没有复制（%2$d层级），查询：%3$s',
	'UI:Schema:Class_ReferencingClasses_From_By' => '%1$s被类%2$s参照，通过字段%3$s',
	'UI:Schema:Class_IsLinkedTo_Class_Via_ClassAndAttribute' => '%1$s被关联到%2$s通过%3$s：<em>%4$s</em>',
	'UI:Schema:Links:1-n' => '类指向%1$s（1:n关联）：',
	'UI:Schema:Links:n-n' => '类关联到%1$s（n:n关联）：',
	...
	'UI:AddObjectsOf_Class_LinkedWith_Class_Instance' => '添加%1$s个对象，关联%2$s：%3$s',
	'UI:AddObjectsOf_Class_LinkedWith_Class' => '%1$s',
	'UI:ManageObjectsOf_Class_LinkedWith_Class_Instance' => '管理%1$s个对象，关联%2$s：%3$s',
	...
	'UI:Title:BulkDeletionOf_Count_ObjectsOf_Class' => '批量删除%1$d个%2$s类的对象',
	...
	'UI:Error:CannotDeleteBecause' => '无法删除此对象，原因：%1$s',
	...
	'UI:Archive_User_OnBehalfOf_User' => '%1$s代表%2$s',
	...
	'UI:Delete:CleaningUpRefencesTo_Several_ObjectsOf_Class' => '删除所有对%2$s类的%1$d个对象的引用...',
	'UI:Delete:Done+' => '做了什么...',
	'UI:Delete:_Name_Class_Deleted' => '%1$s——%2$s删除了。',
	'UI:Delete:ConfirmDeletionOf_Name' => '删除%1$s',
	'UI:Delete:ConfirmDeletionOf_Count_ObjectsOf_Class' => '删除%2$s类的%1$d个对象',
	...
	'UI:Delete:Count_Objects/LinksReferencing_Object' => '一共%1$d个对象/关联了%2$s',
	'UI:Delete:Count_Objects/LinksReferencingTheObjects' => '%1$d个对象/关联了一些即将要删除的对象',
	...
	'UI:Delect:Confirm_Count_ObjectsOf_Class' => '请确认要删除下列%2$s类的%1$d个对象.',
	'UI:WelcomeToITop' => '欢迎使用'.ITOP_APPLICATION_SHORT,
	'UI:DetailsPageTitle' => ITOP_APPLICATION_SHORT.'——%1$s——%2$s详细内容',
	...
	'UI:Search:Enlarge' => '放宽搜索',
	'UI:FullTextSearchTitle_Text' => '“%1$s”的结果：',
	'UI:Search:Count_ObjectsOf_Class_Found' => '发现%2$s类的%1$d个对象。',
	...
	'UI:SelectTheTypeOf_Class_ToCreate' => '选择%1$s的类别:',
	...
	'UI:Title:Object_Of_Class_Created' => '%1$s——%2$s创建了。',
	...
	'UI:UserManagement:Action:Stimuli' => '刺激',
	...
	'UI-IncidentManagementOverview-IncidentUnassigned' => '尚未分配处理人的事件',

	'UI:ChangeMgmtMenuOverview:Title' => '变更管理仪表盘',
	'UI-ChangeManagementOverview-ChangeByType' => '按类别划分变更',
	'UI-ChangeManagementOverview-ChangeUnassigned' => '尚未分配处理人的变更',
...
<p><i><b>触发器</b></i>定义了什么时候发送通知。'.ITOP_APPLICATION_SHORT.'核心自带一些触发器，另一些触发器可由扩展提供：
<ol>
	<li>一些触发器执行于特定类的对象被<b>创建</b>，<b>更新</b>或者<b>删除</b>后。</li>
	<li>一些触发器执行于特定类的对象<b>进入</b>或者<b>离开</b>特定</b>状态</b>时。</li>
	<li>一些触发器执行于<b>TTO或者TTR的阈值</b>已经<b>达到</b>时。</li>
</ol>
</p>
<p>
<i><b>操作</b></i>定义触发器执行的操作。目前仅支持2种操作：
<ol>
	<li>发送电子邮件：此类操作定义发送邮件时所使用的模板，以及其他的一些参数，如收件人，优先级等。<br />
	这里有一个专用的页面: <a href="../setup/email.test.php" target="_blank">email.test.php</a>可用于测试和调试PHP的邮件配置。</li>
	<li>外部webhooks：允许与第三方应用集成，通过发送结构化数据至定义的URL。</li>
</ol>
</p>
<p>若要执行，操作必须和触发器相关联。
当与一个触发器关联时，每个操作都被赋予一个顺序号，规定了按什么样的顺序执行这些操作。</p>',
	...
	'UI:iTopVersion:Long' => '%1$s版本%2$s-%3$s构建于%4$s',
	'UI:PropertiesTab' => '属性',
	...
	'UI:Deadline_LessThan1Min' => '小于1分钟',
	...
	'UI:BeforeAdding_Class_ObjectsSaveThisObject' => '在添加更多%1$s之前，保存此对象。',
	...
	'UI:Relation:AttachmentExportOptions_Name' => '附件选项为%1$s',
	...
	'Portal:NoRequestMgmt' => '亲爱的%1$s，您被重定向到这个页面，因为您的账户已被设置成角色“Portal user”。并且，'.ITOP_APPLICATION_SHORT.'没有安装“请求管理”功能。请联系系统管理员。',
	'Portal:Refresh' => '刷新',
	'Portal:Back' => '返回',
	...
	'Portal:CreateNewRequest' => '新建请求',
	'Portal:CreateNewRequestItil' => '新建请求',
	'Portal:CreateNewIncidentItil' => '新建事件报告',
	'Portal:ChangeMyPassword' => '修改密码',
	'Portal:Disconnect' => '断开',
	'Portal:OpenRequests' => '我打开的请求',
	'Portal:ClosedRequests' => '我已关闭的请求',
	'Portal:ResolvedRequests' => '已解决的请求',
	...
	'Portal:TitleRequestDetailsFor_Request' => '请求详情%1$s：',
	'Portal:NoOpenRequest' => '此类别中没有打开的请求。',
	'Portal:NoClosedRequest' => '此分类中没有请求',
	'Portal:Button:ReopenTicket' => '重新打开这个工单',
	'Portal:Button:CloseTicket' => '关闭这个工单',
	'Portal:Button:UpdateRequest' => '更新请求',
	'Portal:EnterYourCommentsOnTicket' => '请评价此工单的解决方案：',
	'Portal:ErrorNoContactForThisUser' => '错误：当前用户没有与任何联系人关联。请联系系统管理员。',
	...
	'UI:Modify_N_ObjectsOf_Class' => '正在修改%1$d个%2$s',
	'UI:Modify_M_ObjectsOf_Class_OutOf_N' => '正在修改%1$d个%2$s，共%3$d个',
	...
	'UI:BulkModify:N_MoreValues' => '%1$d个值...',
	...
	'UI:CaseLog:Header_Date_UserName' => '%1$——%2$s：',
	'UI:CaseLog:InitialValue' => '初始值：',
	'UI:AttemptingToSetASlaveAttribute_Name' => '字段%1$s不可写，因为它由数据同步控制。值未设置。',
	'UI:ActionNotAllowed' => '您无权操作这些对象。',
	'UI:BulkAction:NoObjectSelected' => '请至少选择一个对象进行操作',
	'UI:AttemptingToChangeASlaveAttribute_Name' => '字段%1$s为不可写，因为其由数据同步控制。值保持未修改。',
	...
	'UI:FavoriteOrganizations+' => '进入组织下的列表，可实现通过下拉菜单快速访问。请注意，这并不是一个安全设置，其他组织的对象依然可以通过选择“所有组织”下拉列表来显示。',
	'UI:FavoriteLanguage' => '语言',
	'UI:Favorites:SelectYourLanguage' => '选择语言',
	'UI:FavoriteOtherSettings' => '其他设置',
	'UI:Favorites:Default_X_ItemsPerPage' => '默认列表：每页%1$s个项目',
	...
	'UI:ExplainPrintable' => '点击%1$s图标可隐藏打印内容。<br/>在打印之前可使用浏览器的“打印预览”功能.<br/>注：这个页首和其他控制面板不会被打印。',
	'UI:PrintResolution:FullSize' => '全尺寸',
	'UI:PrintResolution:A4Portrait' => 'A4纵向',
	'UI:PrintResolution:A4Landscape' => 'A4横向',
	...
	'UI:OQL:UnknownClassAndFix' => '未知类“%1$s”，您可以试试“%2$s”。',
	'UI:OQL:UnknownClassNoFix' => '未知类“%1$s”',

	'UI:Dashboard:EditCustom' => '编辑自定义版本...',
	'UI:Dashboard:CreateCustom' => '新建自定义版本...',
	'UI:Dashboard:DeleteCustom' => '删除自定义版本...',
	'UI:Dashboard:RevertConfirm' => '所有地方都会恢复到初始版本。请确认您要这样做。',
	...
	'UI:Dashboard:NotUpToDateUntilContainerSaved' => '此仪表盘显示的信息不包含实时更新的内容。',
	...
	'UI:DashletProxy:Description' => '代理组件',
	...
	'UI:DashletObjectList:Description' => '对象列表组件',
	...
	'UI:DashletGroupBy:Prop-GroupBy:Hour' => '第%1$s个小时（0-23）',
	'UI:DashletGroupBy:Prop-GroupBy:Month' => '第%1$s个月（1-12）',
	'UI:DashletGroupBy:Prop-GroupBy:DayOfWeek' => '星期的天数为%1$s',
	'UI:DashletGroupBy:Prop-GroupBy:DayOfMonth' => '月份的天数为%1$s',
	'UI:DashletGroupBy:Prop-GroupBy:Select-Hour' => '%1$s（小时）',
	'UI:DashletGroupBy:Prop-GroupBy:Select-Month' => '%1$s（月）',
	'UI:DashletGroupBy:Prop-GroupBy:Select-DayOfWeek' => '%1$s（星期的天数）',
	'UI:DashletGroupBy:Prop-GroupBy:Select-DayOfMonth' => '%1$s（月份的天数）',
	'UI:DashletGroupBy:MissingGroupBy' => '请选择对象分组所依据的字段',
	...
	'UI:GroupBy:sum' => '总数',
	'UI:GroupBy:sum+' => '总和为%1$s',
	'UI:GroupBy:avg' => '平均',
	'UI:GroupBy:avg+' => '平均为%1$s',
	'UI:GroupBy:min' => '最小',
	'UI:GroupBy:min+' => '最小为%1$s',
	'UI:GroupBy:max' => '最大',
	'UI:GroupBy:max+' => '最大为%1$s',
	// ---
	...
	'UI:DashletHeaderDynamic:Label' => '有统计的标题',
	'UI:DashletHeaderDynamic:Description' => '有统计的标题（按其分组...）',
	...
	'UI:DashletBadge:Description' => '新建/搜索时的对象图标',
	...
	'Class:ShortcutOQL/Attribute:oql+' => '定义要查询的对象列表的OQL',
...
<tr><td>Y</td><td>年（4位数，比如2016）</td></tr>
<tr><td>y</td><td>年（2位数，比如16代表2016）</td></tr>
<tr><td>m</td><td>月（2位数，比如01..12）</td></tr>
<tr><td>n</td><td>月（1位数或2位数，比如1..12）</td></tr>
<tr><td>d</td><td>日（2位数，比如0..3）</td></tr>
<tr><td>j</td><td>日（1位数或2位数，比如 1..31）</td></tr>
<tr><td>H</td><td>时（24小时，2位数，比如00..23）</td></tr>
<tr><td>h</td><td>时（12小时，2位数，比如01..12）</td></tr>
<tr><td>G</td><td>时（24小时，1位数或2位数，比如0..23）</td></tr>
<tr><td>g</td><td>时（12小时，1位数或2位数，比如1..12）</td></tr>
<tr><td>a</td><td>时，am或者pm（小写）</td></tr>
<tr><td>A</td><td>时，AM或者PM（大写）</td></tr>
...
<tr><td>s</td><td>秒（2位数, 比如 00..59）</td></tr>
	...
	'UI:DisconnectedDlgMessage' => '您的连接已断开。要继续使用，需要重新验证您的用户名和密码。',
	...
	'UI:CurrentObjectIsLockedBy_User_Explanation' => '此对象正在被%1$s修改。您的修改无法提交因为它们会冲突。',
	'UI:CurrentObjectIsSoftLockedBy_User' => '此对象正在被%1$s修改。在他们完成之后您将可以提交您的修改。',
	'UI:CurrentObjectLockExpired' => '并发修改的锁定已过期。',
	'UI:CurrentObjectLockExpired_Explanation' => '防止并发修改的锁定已过期。您不能提交所作的修改，因为此对象允许被其他用户修改。',
	...
	'UI:Search:AutoSubmit:DisabledHint' => '此类已禁用自动提交',
	...
	'UI:Search:Criteria:Title:Default:GreaterThan' => '%1$s大于%2$s',
	'UI:Search:Criteria:Title:Default:GreaterThanOrEquals' => '%1$s大于等于%2$s',
	'UI:Search:Criteria:Title:Default:LessThan' => '%1$s小于%2$s',
	'UI:Search:Criteria:Title:Default:LessThanOrEquals' => '%1$s小于等于%2$s',
	'UI:Search:Criteria:Title:Default:Different' => '%1$s不等于%2$s',
	'UI:Search:Criteria:Title:Default:Between' => '%1$s位于[%2$s]',
	...
	//   None yet
	//   - DateTime widget
	'UI:Search:Criteria:Title:DateTime:Between' => '%2$s小于等于1$s小于等于%3$s',
	//   - Enum widget
	'UI:Search:Criteria:Title:Enum:In' => '%1$s：%2$s',
	'UI:Search:Criteria:Title:Enum:In:Many' => '%1$：%2$s和%3$s其他',
	'UI:Search:Criteria:Title:Enum:In:All' => '%1$s：任何',
	//   - TagSet widget
	'UI:Search:Criteria:Title:TagSet:Matches' => '%1$s：%2$s',
	//   - External key widget
	'UI:Search:Criteria:Title:ExternalKey:Empty' => '%1$s已定义',
	'UI:Search:Criteria:Title:ExternalKey:NotEmpty' => '%1$s未被定义',
	...
	'UI:Search:Criteria:Operator:Numeric:GreaterThanOrEquals' => '大于等于',// > '>=',
	'UI:Search:Criteria:Operator:Numeric:LessThan' => '小于',// => '<',
	'UI:Search:Criteria:Operator:Numeric:LessThanOrEquals' => '小于等于',// > '<=',
	'UI:Search:Criteria:Operator:Numeric:Different' => '不等于',// => '≠',
	//   - Tag Set Widget
	...
	'UI:Search:Criteria:Raw:FilteredOn' => '基于%1$s过滤',
