...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:AuditCategory+'                                   => '审计类别定义了审计对象的范围.
它汇集了所有应用于特定范围内的审计规则',
	'Class:AuditCategory/Attribute:name'                     => '类别名称',
	'Class:AuditCategory/Attribute:name+'                    => '明确审计对象的范围',
	'Class:AuditCategory/Attribute:description'              => '描述',
	'Class:AuditCategory/Attribute:description+'             => '此审计类别的详细描述',
	'Class:AuditCategory/Attribute:definition_set'           => '对象范围',
	'Class:AuditCategory/Attribute:definition_set+'          => '用于定义审计对象集合的 OQL 表达式',
	'Class:AuditCategory/Attribute:rules_list'               => '审计规则',
	'Class:AuditCategory/Attribute:rules_list+'              => '此类别的审计规则',
	'Class:AuditCategory/Attribute:ok_error_tolerance'       => '警告阈值',
	'Class:AuditCategory/Attribute:ok_error_tolerance+'      => '结果显示为警告(橙色)时允许的最大无效对象百分比',
	'Class:AuditCategory/Attribute:warning_error_tolerance'  => '报错阈值',
	'Class:AuditCategory/Attribute:warning_error_tolerance+' => '结果显示为报错(红色)时允许的最大无效对象百分比',
	'Class:AuditCategory/Attribute:domains_list'             => '审计域',
	'Class:AuditCategory/Attribute:domains_list+'            => '此审计类别相关的审计域列表',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:AuditRule+'                                  => '每条审计规则对应审计类别中的一项检查.
它应用于审计规则定义的对象范围',
	'Class:AuditRule/Attribute:name'                    => '规则名称',
	'Class:AuditRule/Attribute:name+'                   => '规则的简短描述',
	...
	'Class:AuditRule/Attribute:valid_flag+'             => '运行的查询返回有效对象还是无效对象?
"有效对象": 错误对象是范围内的对象但不在有效对象列表中,
"无效对象": 错误对象是范围内的无效对象',
	'Class:AuditRule/Attribute:valid_flag/Value:true'   => '有效对象',
	'Class:AuditRule/Attribute:valid_flag/Value:true+'  => '错误对象是范围内的对象但不在有效对象列表中',
	'Class:AuditRule/Attribute:valid_flag/Value:false'  => '无效对象',
	'Class:AuditRule/Attribute:valid_flag/Value:false+' => '错误对象是范围内的无效对象',
	...
	'Class:AuditRule/Attribute:category_name+'          => '该规则对应的类别名称',
]);
...
审计域通常对应负责检查和修复错误的人',
	...
	'Class:AuditDomain/Attribute:name+'             => '这是审计的一种分类,根据负责整改或对它感兴趣的人进行划分',
	...
	'Class:AuditDomain/Attribute:categories_list'   => '审计类别',
	'Class:AuditDomain/Attribute:categories_list+'  => '相关的审计类别',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:User/Error:PortalPowerUserHasInsufficientRights' => '门户高级用户角色没有提供足够的访问权限 (必须添加另一个角色)',
	...
	'Class:User/Warning:NoOrganizationMeansFullAccess' => '此用户未定义"允许的组织",这意味着他们可以访问所有组织',
	'Class:User/Warning:NoContactHasImpact' => '注意:此用户未定义个体,这将阻止访问门户、新闻通知以及后台的其它副作用',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_Dimensions/Attribute:type+' => '类型名称或数据类型 (映射单位)',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_UserProfile/Name' => '%1$s 和 %2$s 之间的链接',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_UserOrg/Name' => '%1$s 和 %2$s 之间的链接',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:URP_ClassProjection' => '类别映射',
	'Class:URP_ClassProjection+' => '类别映射',
	...
	'Class:URP_ClassProjection/Attribute:class' => '类别',
	'Class:URP_ClassProjection/Attribute:class+' => '目标类别',
	'Class:URP_ClassProjection/Attribute:value' => '值表达式',
	'Class:URP_ClassProjection/Attribute:value+' => 'OQL 表达式 (使用$this) | constant |  | +attribute code',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_ActionGrant/Attribute:class' => '类别',
	'Class:URP_ActionGrant/Attribute:class+' => '目标类别',
	...
	'Class:URP_ActionGrant/Attribute:action+' => '基于指定类别的操作',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_StimulusGrant/Attribute:class' => '类别',
	'Class:URP_StimulusGrant/Attribute:class+' => '目标类别',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:URP_AttributeGrant/Attribute:actiongrantid' => '操作授权',
	'Class:URP_AttributeGrant/Attribute:actiongrantid+' => '操作授权',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'UI:Error:MandatoryTemplateParameter_target_attr' => '当 link_attr 被指定时, 参数target_attr是必须的. 请检查显示模板的定义.',
	...
	'UI:Error:IncorrectLinkDefinition_LinkedClass_Class' => '链接错误: 链接的对象: %1$s 不是 %2$s 的外键',
	...
	'UI:Error:2ParametersMissing'                   => '错误: 必须为此操作指定以下参数: %1$s 和 %2$s.',
	'UI:Error:3ParametersMissing'                   => '错误: 必须为此操作指定以下参数: %1$s, %2$s 和 %3$s.',
	'UI:Error:4ParametersMissing'                   => '错误: 必须为此操作指定以下参数: %1$s, %2$s, %3$s 和 %4$s.',
	...
	'UI:Error:BulkDeleteNotAllowedOn_Class'         => '您无权批量删除 %1$s',
	'UI:Error:DeleteNotAllowedOn_Class'             => '您无权删除 %1$s',
	'UI:Error:ReadNotAllowedOn_Class'               => '您无权查看 %1$s',
	'UI:Error:BulkModifyNotAllowedOn_Class'         => '您无权批量更新 %1$s',
	...
	'UI:NoObject_Class_ToDisplay'   => '没有 %1$s 可显示',
	'UI:History:LastModified_On_By' => '最近被 %2$s 修改了 %1$s.',
	'UI:HistoryTab'                 => '历史',
	'UI:NotificationsTab' => '通知',
	'UI:History:BulkImports' => '历史',
	'UI:History:BulkImports+' => 'CSV 导入列表 (最新导入在最前面)',
	'UI:History:BulkImportDetails' => '在 %1$s 执行CSV 导入时造成的变更 (由 %2$s)',
	'UI:History:Date' => '日期',
	...
	'UI:Menu:Transitions' => '切换',
	'UI:Menu:OtherTransitions' => '其它切换',
	'UI:Menu:View' => '查看此对象',
	'UI:Menu:New' => '新建...',
	'UI:Menu:Add' => '添加...',
	'UI:Menu:Manage' => '管理...',
	...
	'UI:Menu:BulkDelete_Class' => '删除 %1$s ...',
	...
	'UI:CSVImport:ErrorExtendedAttCode'         => '内部错误: "%1$s" 是不正确的代码, 因为 "%2$s" 不是 "%3$s" 的外键',
	...
	'UI:CSVImport:PasteData'                  => '粘贴数据并导入:',
	...
	'UI:CSVImport:AdvancedMode+'              => '在高级模式中, 对象的 "id" (主键) 可以被用来修改和重命名对象.'.
		'不管怎样, 列 "id" (如果存在) 只能被用作搜索条件, 且不能与其它搜索条件混用.',
	'UI:CSVImport:SelectAClassFirst'          => '要配置映射, 请先选择一个类别.',
	...
	'UI:CSVExport:AdvancedMode+' => '在高级模式下, 导出时将会增加多个列: 对象id, 外键id及其调和属性.',
	...
	'UI:Audit:Interactive:All:SubTitle'           => '全量审计: 包括所有审计规则、审计类别、审计域',
	...
	'UI:Audit:Interactive:Categories:SubTitle'    => '所有属于类别 %1$s 的规则的审计结果',
	'UI:Audit:Interactive:Categories:BreadCrumb'  => '类别',
	'UI:Audit:Interactive:Categories:BreadCrumb+' => '审计类别: %1$s',
	'UI:Audit:Interactive:Domain:Title'           => '审计结果: %1$s',
	'UI:Audit:Interactive:Domain:SubTitle'        => '此审计域内所有审计规则的审计结果: %1$s',
	'UI:Audit:Interactive:Domain:BreadCrumb'      => '%1$s',
	'UI:Audit:Interactive:Domain:BreadCrumb+'     => '审计域: %1$s',
	'UI:Audit:Interactive:Selection:Title'        => '选择审计',
	'UI:Audit:Interactive:Selection:SubTitle'     => '请选择一个审计域并将结果限定在该域内或者选择 "所有类别" 进行全量审计 (如果要审计的数据量太大可能导致耗时较长甚至失败)',
	...
	'UI:Audit:Interactive:Button:Back'            => '返回到审计',
	...
	'UI:Audit:ErrorIn_Rule_Reason'                  => 'OQL 错误在规则 %1$s 中: %2$s.',
	'UI:Audit:ErrorIn_Category'                     => '类别中有错误',
	'UI:Audit:ErrorIn_Category_Reason'              => 'OQL 错误在类别 %1$s 中: %2$s.',
	'UI:Audit:AuditErrors'                          => '审计报错',
	'UI:Audit:Dashboard:ObjectsAudited'             => '已审计',
	'UI:Audit:Dashboard:ObjectsInError'             => '报错',
	'UI:Audit:Dashboard:ObjectsValidated'           => '已验证',
	'UI:Audit:AuditCategory:Subtitle'               => '%2$s 个中有 %1$s 个错误 - 共 %3$s%% 个有效对象',
	...
	'UI:RunQuery:DevelopedOQLCount'    => '优化的 OQL 个数',
	'UI:RunQuery:ResultSQLCount'       => '结果 SQL 个数',
	'UI:RunQuery:ResultSQL'            => '结果 SQL',
	'UI:RunQuery:Error'                => '运行此查询时发生了一个错误',
	'UI:Query:UrlForExcel'             => '用于MS-Excel 的网络查询URL',
	...
	'UI:Schema:AbstractClass'          => '抽象类: 此类别不能实例化对象.',
	'UI:Schema:NonAbstractClass'       => '非抽象类: 此类别可以实例化对象.',
	'UI:Schema:ClassHierarchyTitle'    => '类别层级',
	'UI:Schema:AllClasses' => '所有类别',
	...
	'UI:Schema:ReferencingClasses' => '参考类别',
	'UI:Schema:RelatedClasses' => '相关类别',
	...
	'UI:Schema:Class_ReferencingClasses_From_By' => '%1$s 被类 %2$s 引用, 通过字段 %3$s',
	'UI:Schema:Class_IsLinkedTo_Class_Via_ClassAndAttribute' => '%1$s 被链接到 %2$s 通过 %3$s::<em>%4$s</em>',
	'UI:Schema:Links:1-n' => '类别指向 %1$s (1:n 链接):',
	'UI:Schema:Links:n-n' => '类别链接到 %1$s (n:n 链接):',
	'UI:Schema:Links:All' => '全部相关类别的图',
	'UI:Schema:NoLifeCyle' => '此类别未定义生命周期.',
	'UI:Schema:LifeCycleTransitions' => '状态切换',
	...
	'UI:Title:BulkDeletionOf_Count_ObjectsOf_Class' => '批量删除 %1$d 个 %2$s',
	...
	'UI:Delete:Done+' => '做了什么...',
	'UI:Delete:_Name_Class_Deleted' => '%1$s - %2$s 已删除.',
	'UI:Delete:ConfirmDeletionOf_Name' => '删除 %1$s',
	'UI:Delete:ConfirmDeletionOf_Count_ObjectsOf_Class' => '删除 %1$d 个 %2$s',
	'UI:Delete:CannotDeleteBecause' => '无法删除: %1$s',
	'UI:Delete:ShouldBeDeletedAtomaticallyButNotPossible' => '应该自动删除, 但您无权这样做',
	'UI:Delete:MustBeDeletedManuallyButNotPossible' => '必须手动删除 - 但不可行: %1$s',
	'UI:Delete:WillBeDeletedAutomatically' => '将会被自动删除',
	'UI:Delete:MustBeDeletedManually' => '必须手动删除',
	'UI:Delete:CannotUpdateBecause_Issue' => '本应被自动更新, 但是: %1$s',
	'UI:Delete:WillAutomaticallyUpdate_Fields' => '将被自动更新 (重置: %1$s)',
	'UI:Delete:Count_Objects/LinksReferencing_Object' => '%1$d 个对象/链接正在引用 %2$s',
	'UI:Delete:Count_Objects/LinksReferencingTheObjects' => '%1$d 个对象/链接正在引用一些将要被删除的对象',
	...
	'UI:Delete:PleaseDoTheManualOperations' => '在删除对象之前, 请先手动完成上述操作',
	'UI:Delete:Confirm_Object' => '请确认删除 %1$s.',
	...
	'UI:DetailsPageTitle' => ITOP_APPLICATION_SHORT.' - %1$s - %2$s 详情',
	...
	'UI:FullTextSearchTitle_Text' => '"%1$s" 的搜索结果:',
	'UI:Search:Count_ObjectsOf_Class_Found' => '找到 %1$d 个 %2$s.',
	'UI:Search:NoObjectFound' => '找不到对象.',
	...
	'UI:UserManagement:Class' => '类别',
	'UI:UserManagement:Class+' => '对象的类别',
	...
	'UI-ServiceManagementOverview-CustomerContractToRenew' => '在30天内到期的客户合同',
	'UI-ServiceManagementOverview-ProviderContractToRenew' => '在30天内到期的供应商合同',
...
<p><i><b>触发器</b></i>定义了什么时候发送通知. '.ITOP_APPLICATION_SHORT.' 内部自带了一些触发器, 另一些触发器则由扩展提供:
<ol>
	<li>有的触发器执行于指定类别的对象被<b>创建后</b>, <b>更新后</b>或<b>删除后</b>.</li>
	<li>有的触发器执行于指定类别的对象<b>进入</b>或<b>离开</b>指定</b>状态</b>.</li>
...
<ol>
	<li>发送邮件消息: 此动作同时需要指定发送的邮件所使用的模板, 以及一些其它参数, 例如收件人, 优先级, 等.<br />
	这里有一个专用的页面: <a href="../setup/email.test.php" target="_blank">email.test.php</a>可用于测试和调试PHP的邮件配置.</li>
	<li>发送消息到新闻室: 在应用程序中直接通过新闻室给用户发送消息 (左侧的铃铛图标)</li>
	<li>调用外部webhook: 允许通过发送结构化数据到指定URL 来与第三方应用集成.</li>
</ol>
</p>
<p>若要执行, 操作必须和触发器相关联.
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'UI:NotificationsMenu:OnCreate' => '当对象被创建时',
	'UI:NotificationsMenu:OnStateEnter' => '当对象进入指定状态时',
	'UI:NotificationsMenu:OnStateLeave' => '当对象离开指定状态时',
	'UI:NotificationsMenu:Actions' => '操作',
	'UI:NotificationsMenu:Actions:ActionEmail' => '邮件操作',
	'UI:NotificationsMenu:Actions:ActionWebhook' => 'Webhook 操作(外部集成)',
	...
	'UI:iTopVersion:Long' => '%1$s 版本 %2$s-%3$s 构建于 %4$s',
	'UI:PropertiesTab' => '属性',
	...
	'UI:Relation:ExportAsPDF' => '导出 PDF...',
	...
	'Portal:SelectSubcategoryFrom_Service' => '请选择服务 %1$s 的子类:',
	'Portal:PleaseSelectAServiceSubCategory' => '请选择一项子类',
	'Portal:DescriptionOfTheRequest' => '请输入描述:',
	'Portal:TitleRequestDetailsFor_Request' => '需求详情 %1$s:',
	'Portal:NoOpenRequest' => '此类别中没有打开的需求.',
	'Portal:NoClosedRequest' => '此类别中没有打开的需求',
	...
	'Portal:ErrorNoContactForThisUser' => '错误: 当前用户没有关联任何联系人. 请联系管理员.',
	'Portal:Attachments' => '附件',
	'Portal:AddAttachment' => ' 添加附件 ',
	'Portal:RemoveAttachment' => ' 移除附件 ',
	'Portal:Attachment_No_To_Ticket_Name' => '附加 #%1$d 到 %2$s (%3$s)',
	...
	'UI:Modify_ObjectsOf_Class' => '正在修改 %1$s',
	...
	'UI:Menu:ModifyAll_Class' => '修改 %1$s ...',
	...
	'UI:AttemptingToChangeASlaveAttribute_Name' => '字段 %1$s 不可写，因为它由数据同步管理,值保持不变。',
	'UI:Pagination:HeaderSelection' => '一共: %1$s 项 (已选 %2$s 项).',
	'UI:Pagination:HeaderNoSelection' => '一共: %1$s 项.',
	'UI:Pagination:PageSize' => '每页 %1$s 项',
	'UI:Pagination:PagesLabel' => '页:',
	'UI:Pagination:All' => '全部',
	'UI:HierarchyOf_Class' => '%1$s架构',
	'UI:Preferences' => '偏好设置...',
	...
	'UI:Favorites:Default_X_ItemsPerPage' => '默认行数: 每页显示 %1$s 项',
	'UI:Favorites:ShowObsoleteData' => '显示已废弃的数据',
	...
	'UI:AutoApplyConfirmationMessage' => '有些修改尚未生效. 您希望这些更改立即生效吗?',
	'UI:Create_Class_InState' => '创建 %1$s 并设置状态为: ',
	...
	'UI:DashletUnknown:Description' => '未知的仪表盘 (可能已卸载)',
	'UI:DashletUnknown:RenderText:View' => '此仪表盘无法渲染.',
	'UI:DashletUnknown:RenderText:Edit' => '此仪表盘无法渲染 (类别 "%1$s"). 请与管理员确认其可用.',
	'UI:DashletUnknown:RenderNoDataText:Edit' => '此仪表盘无预览(类别 "%1$s").',
	'UI:DashletUnknown:Prop-XMLConfiguration' => '配置 (显示为纯XML)',

	'UI:DashletProxy:Label' => '代理',
	'UI:DashletProxy:Description' => '代理仪表盘',
	'UI:DashletProxy:RenderNoDataText:Edit' => '第三方仪表盘不可预览 (类别 "%1$s").',
	...
	'UI:DashletObjectList:Label' => '无序列表',
	...
	'UI:DashletGroupBy:Prop-GroupBy:DayOfMonth' => '%1$s 月天数',
	...
	'UI:DashletGroupByPie:Description' => '饼状图',
	'UI:DashletGroupByBars:Label' => '柱状图',
	'UI:DashletGroupByBars:Description' => '柱状图',
	'UI:DashletGroupByTable:Label' => '分组表格',
	'UI:DashletGroupByTable:Description' => '表格 (按字段分组)',
...
<tr><td>a</td><td>时, am 或 pm (小写)</td></tr>
<tr><td>A</td><td>时, AM 或 PM (大写)</td></tr>
...
<tr><td>s</td><td>秒 (2位数, 例如 00..59)</td></tr>
	...
	'UI:CurrentObjectIsLockedBy_User' => '对象已被锁定, 因为 %1$s 正在修改.',
	'UI:CurrentObjectIsLockedBy_User_Explanation' => '此对象正在被 %1$s 修改. 您的修改无法提交以避免冲突.',
	'UI:CurrentObjectIsSoftLockedBy_User' => '此对象当前正在被 %1$s 修改. 在其修改结束后您将能提交您的修改.',
	'UI:CurrentObjectLockExpired' => '并发修改的锁定期已过.',
	'UI:CurrentObjectLockExpired_Explanation' => '防止对象被并发修改的锁已过期. 您无法再提交修改，因为其它用户现在被允许修改此对象.',
	'UI:ConcurrentLockKilled' => '阻止并发修改当前对象的锁已被消除.',
	'UI:Menu:KillConcurrentLock' => '消除并发修改锁定!',

	'UI:Menu:ExportPDF' => '导出 PDF...',
	'UI:Menu:PrintableVersion' => '优质打印',
	...
	'UI:Search:AutoSubmit:DisabledHint' => '此类别已禁止自动提交',
	'UI:Search:Obsolescence:DisabledHint' => '根据您的偏好, 废弃的数据已被隐藏',
