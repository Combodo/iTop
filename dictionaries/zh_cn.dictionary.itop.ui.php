...
<div>定制化您的'.ITOP_APPLICATION.'设置,实现个性化体验.</div>',
	...
	'UI:SelectTheTypeOf_Class_ToCreate' => '选择%1$s的类:',
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'UI:Modify_ObjectsOf_Class' => '修改类%1$s的对象',
	...
	'UI:DashletUnknown:RenderText:Edit' => '此仪表盘无法渲染 (类 "%1$s"). 请与管理员确认其可用.',
	'UI:DashletUnknown:RenderNoDataText:Edit' => '此仪表盘无预览 (类 "%1$s").',
