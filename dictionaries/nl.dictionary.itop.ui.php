...
<li>Het managen van het belangrijkste middel van uw IT: Documentatie.</li>
	...
	'UI:Error:SaveFailed' => 'Object kan niet bewaard worden:',
	...
	'UI:Error:IncorrectLinkDefinition_LinkedClass_Class' => 'Incorrecte linkdefinitie: de klasse van objecten om te managen: %1$s is niet gevonden als externe sleutel (key) in de klasse %2$s',
	...
	'UI:CSVImport:ErrorExtendedAttCode' => 'Interne error: "%1$s" is een incorrecte code omdat "%2$s" geen externe sleutel (key) van klasse "%3$s" is',
	...
	'UI:CSVImport:AdvancedMode+' => 'In advanced mode kan het "id" (primaire sleutel (key)) van de objecten worden gebruikt om deze te updaten en te hernoemen.' .
...
Indien gekoppeld aan een Trigger, wordt aan elke actie een "orde" nummer gegeven, dat specificeert in welke volgorde de acties moeten worden uitgevoerd.</p>',
	...
	'UI:FavoriteOrganizations+' => 'Duid in onderstaande lijst de organisaties aan die u wilt zien in het drop-down menu voor een snelle toegang. '.
								   'Merk op dat dit geen beveiligingsinstelling is, objecten van elke organisatie zijn nog steed zichtbaar en toegankelijk door "Alle Organisaties" te selecteren in de drop-down list.',
	...
	'UI:RelationTooltip:CriticalThreshold_N_of_M' => 'Kritische drempellwaarde: %1$d / %2$d',
