...
<li>Een database met bekende problemen om de oplossing van incidenten te versnellen.</li>
...
<p>
<ul>De adoptie van dit IT Operational portaal van de nieuwste generatie zal jehelpen met:
...
<li>Het managen van het belangrijkste middel van jouw IT: Documentatie.</li>
</ul>
</p>',
	...
	'UI:Error:UploadedFileTooBig' => 'Het geüploade bestand is te groot. (Maximale grootte is %1$s). Contacteer jouw iTop-administrator om deze limiet aan te passen. (Check de PHP-configuratie voor upload_max_filesize en post_max_size op de server).',
	...
	'UI:Error:BulkDeleteNotAllowedOn_Class' => 'Je bent niet gemachtigd tot het grootschalig verwijderen van objecten in klasse %1$s',
	'UI:Error:DeleteNotAllowedOn_Class' => 'Je bent niet gemachtigd objecten in klasse %1$s te verwijderen',
	'UI:Error:BulkModifyNotAllowedOn_Class' => 'Je bent niet gemachtigd tot een grootschalige update van objecten in klasse %1$s',
	...
	'UI:Login:IdentifyYourself' => 'Identificeer uzelf voordat je verder gaat',
	...
	'UI:Login:ForgotPwdForm+' => 'iTop kan je een e-mail sturen waarin je de instructies voor het resetten van jouw account kunt vinden.',
	...
	'UI:ResetPwd-Error-NoEmailAtt' => 'deze account is niet gelinkt aan een persoon die beschikt over een e-mail attribuut. Neem contact op met jouw administrator.',
	'UI:ResetPwd-Error-NoEmail' => 'Er mist een e-mailadres. Neem contact op met jouw administrator.',
	'UI:ResetPwd-Error-Send' => 'Er is een technisch probleem bij het verzenden van de e-mail. Neem contact op met jouw administrator.',
	...
	'UI:ResetPwd-Error-InvalidToken' => 'Sorry, of jouw wachtwoord is al gereset, of je heeft al meerdere e-mails ontvangen. Zorg ervoor dat je de link in de laatst ontvangen e-mail gebruikt.',
	...
	'UI:Login:Error:AccessRestricted' => 'iTop toegang is verboden. Neem contact op met een iTop administrator.',
	'UI:Login:Error:AccessAdmin' => 'Alleen toegankelijk voor mensen met administrator rechten. Neem contact op met een iTop administrator',
	...
	'UI:CSVImport:AlertMultipleMapping' => 'Zorg er voor dat het veld slechts een keer gemapped is',
	...
	'UI:CSVExport:LostChars+' => 'Het gedownloade bestand zal worden gecodeerd in %1$s. iTop heeft een aantal karakters gedetecteerd die niet compatible zijn met deze format. Deze karakters zullen worden vervangen door een ander karakter (bijvoorbeeld karakters met accent, zullen het accent verliezen), of ze zullen worden verwijderd. U kunt data kopiÃ«ren en plakken van jouw web browser. Ook kunt je de administrator contacteren om de codes te veranderen (Zie parameter \'csv_file_default_charset\').',
...
Indien gekoppeld aan een Trigger, wordt aan elke actie een "orde" nummer gegeven, dat specificeert in welke volgorde de acties moeten worden uitgevoerd.</p>',
	...
	'Portal:NoRequestMgmt' => 'Beste %1$s, je bent naar deze pagina doorverwezen omdat jouw account is geconfigureerd met het profiel \'Portal user\'. Helaas is iTop niet geïnstalleerd met de feature \'Request Management\'. Neem contact op met jouw administrator.',
	...
	'Portal:ErrorNoContactForThisUser' => 'Fout: de huidige gebruiker is niet gelinkt aan een persoon/contact. Neem contact op met jouw administrator.',
