...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:Query/Attribute:export_count+' => 'Counter reflecting the number of times this query has been executed',
...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:User/Attribute:org_id+' => 'Organisation of the associated person',
	...
	'Class:User/Attribute:allowed_org_list' => 'Allowed Organisations',
	'Class:User/Attribute:allowed_org_list+' => 'The end user is allowed to see data belonging to the following organisations. If no organisation is specified, there is no restriction.',
	...
	'Class:User/Error:OrganizationNotAllowed' => 'Organisation not allowed.',
	'Class:User/Error:UserOrganizationNotAllowed' => 'The user account does not belong to your allowed organisations.',
	'Class:User/Error:PersonIsMandatory' => 'The Contact is mandatory.',
	'Class:User/Warning:NoOrganizationMeansFullAccess' => 'No "Allowed Organisations" defined for this user, this means they have access to all organisations',
...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:URP_UserOrg/Attribute:allowed_org_id+' => 'Allowed organisation',
...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'UI:AllOrganizations' => ' All Organisations ',
	...
	'UI:Error:AnErrorOccuredWhileRunningTheQuery_Message' => 'An error occurred while running the query: %1$s',
	...
	'UI:CSVImport:ObjectsWillBeModified' => '%1$d object(s) will be modified.',
	'UI:CSVImport:ObjectsWillBeAdded' => '%1$d object(s) will be added.',
	'UI:CSVImport:ObjectsWillHaveErrors' => '%1$d object(s) will have errors.',
	'UI:CSVImport:ObjectsRemainedUnchanged' => '%1$d object(s) remained unchanged.',
	'UI:CSVImport:ObjectsWereModified' => '%1$d object(s) were modified.',
	'UI:CSVImport:ObjectsWereAdded' => '%1$d object(s) were added.',
	'UI:CSVImport:ObjectsHadErrors' => '%1$d object(s) had errors.',
	...
	'UI:CSVImport:AlertNoSearchCriteria' => 'Please select at least one search criterion',
	...
	'UI:CSVReport-Row-Issue-Inconsistent' => 'Attributes not consistent with each other: %1$s',
	...
	'UI:Schema:AvailOperators+' => 'Possible operators for this search criterion',
...
When associated with a trigger, each action is given an "order" number, specifying in which order the actions are to be executed.</p>',
	...
	'Portal:SelectService' => 'Select a service from the catalogue:',
	...
	'UI:AttemptingToSetASlaveAttribute_Name' => 'The field %1$s (%2$s) is not writable because it is mastered by the data synchronisation. Value not set.',
	...
	'UI:AttemptingToChangeASlaveAttribute_Name' => 'The field %1$s is not writable because it is mastered by the data synchronisation. Value remains unchanged.',
