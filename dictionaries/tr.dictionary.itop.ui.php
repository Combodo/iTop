...
Dict::Add('TR TR', 'Turkish', 'Türkçe', [
	...
	'UI:Delete:Confirm_Object' => '%1$s\'i silmek istediğnizden emin misiniz?',
	'UI:Delete:Confirm_Count_ObjectsOf_Class' => '%1$d nesnesini (sınıfı %2$s) silmek istediğinizden emin misiniz?',
