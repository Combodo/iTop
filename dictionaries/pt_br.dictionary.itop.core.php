...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:ActionEmail/Attribute:test_recipient+' => 'Destinatário caso o status esteja definido como "Em homologação"',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:SynchroDataSource/Attribute:user_delete_policy/Value:everybody' => 'Permissão para todos excluir esses objetos',
	...
	'Core:BulkExport:DragAndDropHelp' => 'Arraste e solte os cabeçalhos das colunas para organizar as colunas. Visualização de %1$s linhas. Número total de linhas para exportar: %2$s',
	...
	'Core:BulkExport:CSVLocalization' => 'Codificação',
	...
	'Core:BulkExport:OptionNoLocalize' => 'Código de exportação em vez de Rótulo',
