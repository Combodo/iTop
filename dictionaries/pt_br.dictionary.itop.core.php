...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:TriggerOnObject/Attribute:filter+' => 'Limite a lista de objetos (da classe de destino) que irá ativar o gatilho~~',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:TriggerOnObjectMention/Attribute:mentioned_filter+' => 'Limite a lista de objetos mencionados que ativarão o gatilho. Se vazio, qualquer objeto mencionado (de qualquer classe) irá ativá-lo.~~',
));
