...
Dict::Add('DE DE', 'German', 'Deutsch', array(
	...
	'Class:URP_UserOrg/Attribute:reason' => 'Grund',
...
<li>und ein besseres Verwalten des wichtigsten Bestandteiles Ihrer IT: der Dokumentation.</li>
	...
	'UI:History:BulkImportDetails' => 'Änderungen durch CSV-Import am %1$s (durch %2$s)',
	...
	'UI:History:StatsCreations+' => 'Anzahl erstellter Objekte',
	'UI:History:StatsModifs' => 'Modifiziert',
	'UI:History:StatsModifs+' => 'Anzahl modifizerter Objekte',
	'UI:History:StatsDeletes' => 'Gelöscht',
	'UI:History:StatsDeletes+' => 'Anzahl gelöschter Objekte',
	'UI:Loading' => 'Laden...',
	...
	'UI:Error:CannotDeleteBecauseOfDepencies' => 'Dieses Objekt konnte nicht gelöscht werden, da aufgrund von Abhängigkeiten zuerst dazu einige manuelle Operationen durchgeführt werden müssen.',
	...
	'UI:Delete:ShouldBeDeletedAtomaticallyButNotPossible' => 'Sollte automatisch gelöscht werden, was leider nicht durchführbar ist: %1$s',
	...
	'UI:SystemIntrusion' => 'Zugriff verweigert. Sie haben versucht, eine Aktion auszuführen, für die Sie keine Berechtigung haben.',
...
Wenn Aktionen mit Trigger verknüpft sind, bekommt jede Aktion eine Auftragsnummer, die die Reihenfolge der auszuführenden Aktionen festlegt.</p>',
	...
	'Portal:Button:ReopenTicket' => 'Ticket wiedereröffnen',
	'Portal:Button:CloseTicket' => 'Dieses Ticket schließen',
	'Portal:Button:UpdateRequest' => 'Request updaten',
	...
	'Portal:Attachment_No_To_Ticket_Name' => 'Attachment #%1$d zu %2$s (%3$s)',
	...
	'UI:Modify_M_ObjectsOf_Class_OutOf_N' => 'Modifiziere %1$d Objekte der Klasse %2$s von %3$d',
	'UI:Menu:ModifyAll' => 'Modifizieren...',
	'UI:Button:ModifyAll' => 'Alle modifizieren',
	'UI:Button:PreviewModifications' => 'Modifikationen-Preview >>',
	'UI:ModifiedObject' => 'Objekt modifiziert',
	'UI:BulkModifyStatus' => 'Operation',
	'UI:BulkModifyStatus+' => '',
	'UI:BulkModifyErrors' => 'Fehler (falls aufgetreten)',
	'UI:BulkModifyErrors+' => '',
	'UI:BulkModifyStatusOk' => 'Ok',
	'UI:BulkModifyStatusError' => 'Fehler',
	'UI:BulkModifyStatusModified' => 'Modifiziert',
	'UI:BulkModifyStatusSkipped' => 'Übersprungen',
	'UI:BulkModify_Count_DistinctValues' => '%1$d eindeutige Werte:',
	'UI:BulkModify:Value_Exists_N_Times' => '%1$s, %2$d mal',
	'UI:BulkModify:N_MoreValues' => '%1$d weitere Werte...',
	'UI:AttemptingToSetAReadOnlyAttribute_Name' => 'Versuche, das Read-Only-Feld zu setzen: %1$s',
	'UI:FailedToApplyStimuli' => 'Der Vorgang ist fehlgeschlagen.',
	'UI:StimulusModify_N_ObjectsOf_Class' => '%1$s: Modifizere %2$d Objekte der Klasse %3$s',
	'UI:CaseLogTypeYourTextHere' => 'Geben Sie hier Ihren Text ein:',
	'UI:CaseLog:DateFormat' => 'Y-m-d H:i:s',
	'UI:CaseLog:Header_Date_UserName' => '%1$s - %2$s:',
	'UI:CaseLog:InitialValue' => 'Initialer Wert:',
	'UI:AttemptingToSetASlaveAttribute_Name' => 'Das Feld %1$s ist nicht schreibbar, weil es durch die Datensynchronisation gesteuert wird. Wert nicht gesetzt.',
	'UI:ActionNotAllowed' => 'Sie haben nicht die Berechtigungen, diese Aktion auf diesen Objekten auszuführen.',
	'UI:BulkAction:NoObjectSelected' => 'Bitte wählen Sie mindestens ein Objekt, um diese Aktion auszuführen.',
	'UI:AttemptingToChangeASlaveAttribute_Name' => 'Das Feld %1$s ist nicht schreibbar, weil es durch die Datensynchronisation gesteuert wird. Wert bleibt unverändert.',
	...
	'UI:FavoriteOrganizations' => 'Meine Favoriten-Organisationen',
