...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:EventNotificationEmail/Attribute:body+' => '邮件正文',
));
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ActionEmail/Attribute:from+' => '邮件的发起人',
	'Class:ActionEmail/Attribute:reply_to' => '回复到',
	'Class:ActionEmail/Attribute:reply_to+' => '邮件的接收人',
	...
	'Class:ActionEmail/Attribute:body+' => '邮件正文',
	'Class:ActionEmail/Attribute:importance' => '重要性',
	'Class:ActionEmail/Attribute:importance+' => '重要等级',
...
Operators:<br/>
	...
	'Class:SynchroReplica/Attribute:info_creation_date' => '创建时间~~',
	'Class:SynchroReplica/Attribute:info_last_modified' => '最新修改时间~~',
	...
	'Core:BulkExportCanRunNonInteractive' => '点击这里进入非交互式导出.~~',
	'Core:BulkExportLegacyExport' => '点击这里进入旧版导入.~~',
	...
	'Core:Validator:MustBeInteger' => '必须为整数~~',
