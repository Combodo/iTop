...
<div>Configurez vos préférences '.ITOP_APPLICATION.' pour une expérience personnalisée.</div>',
	...
	'UI:Audit:InteractiveAudit'                    => 'Résultats d\'audit',
	'UI:Audit:InteractiveAudit:Back'               => 'Retour à l\'audit complet',
	'UI:Audit:InteractiveAudit:ForCategories'      => 'Audit de catégories',
	'UI:Audit:InteractiveAudit:Selection'          => 'Sélection d\'un audit',
	'UI:Audit:InteractiveAudit:Selection+'         => 'Choisir un domaine pour obtenir les résultats d\'audit limités à ce domaine ou l\'"Audit intégral" mais qui peut échouer s\'il y a trop de régles et d\'objets à auditer',
	'UI:Audit:InteractiveAudit:Selection:All'      => 'Audit intégral',
	'UI:Audit:InteractiveAudit:AllCategories'      => 'Complet, incluant toutes les régles, sans limitation de domain ni de catégorie',
	'UI:Audit:InteractiveAudit:SelectedCategories' => 'Limités à %1$s catégorie(s)',
	'UI:Audit:InteractiveAudit:SelectedDomain'     => 'Limités au domaine : %1$s',
	'UI:Audit:ViewRules'                           => 'Vérifier les régles d\'audit',
	'UI:Audit:ModifyCategory'                      => 'Editer la catégorie d\'audit',
